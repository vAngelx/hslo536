var angel_19323 = ['cellsTab2', 'cellsTab3', 'cellsIDTab1', 'cellsIDTab2', 'myCellsTab1', 'myCellsTab2', 'myCellsTab3', 'bound', 
'bound2', 'sortedCells', 'forEach', 'updateStaticBound', 'fadeStartTime', 'teste1', 'isInView', 'isFood', 'isVirus', 'segregator', 'teste2', 
'isMine', 'isInView2', 'teste3', 'isInView3', 'animRadius', 'getCell', 'addCell', 'myCellCheck', 'cellsIDTab3', 'eatCell', 'staticX', 'staticY', 
':removed', 'tab', 'radius', 'classI', 'isEjected', 'isFriend', 'account', 'animX', 'animY', '_000308', '_000307', 'staticMass', 'isUnnamed', 
'_nick', '_nick2', '_skin', '_skin2', '_tag', 'colorHexTab1', 'colorHexTab2', 'mass2', 'controlledTab', 'pieceCount', 'playing', 'playing2', 
'updateData', 'sendAliveData', 'colorObject', 'commanderPoints', 'playerData', 'pieceCount2', 'sqrt', 'pow', 'autoZoomViewport', 'dead', 
'dead2', 'invalidSkinUrl', 'join', '_colorObject', 'location', 'classA', 'isNew', 'isRGB', 'timeStamp', 'cacheIndicator', 'middle', 
'600 150px FontAwesome', 'fillText', 'crossOrigin', 'anonymous', 'edge', 'offset2', 'Tab2LT', 'Tab3LT', 'center2', 'focusedAtCenter', 
'updateOffset2', 'updateOffset3', 'center3', 'Tab3Viewport', 'Tab3ViewBounds', '_freeSpectate', 'updateView', 'move', 'spectatePoints', 
'_isSpectating', 'maxCacheLife', 'nickShadowCtx', 'newShadowContext', 'canvasPool', 'newNickCache', 'level', 'getNewCanvas', 'quality', 
'getNickWidth', '700 ', 'px ', 'strokeText', 'performance', 'measureText', '700 25px ', 'newMassCache', 'lastUsedAt', 'fontSize', 'needsRedraw', 
'getMassWidth', 'massShadowCtx', 'setMassCtxFont', 'getScreenRadius', 'isSmall', '700 25px ubuntu', 'cleaner', 'resetCanvas', '_mass', 
'_fontSize', 'rainbow', 'cacheCanvas', 'cacheCtx', 'shadowBlur', 'strength', 'isGlowOn', 'restore', 'drawImage', 'smaller', 'same', 
'biggerSTE', 'bigger', 'renderGroup', '#2196F3', '#FF9800', '#FD0000', 'viruses', 'skinMap', 'https://i.imgur.com/O5k0G4p.png', 'getCustomSkin', 
'downloadedSkins', 'downloadSkin', 'onload', 'clip', 'toDataURL', 'https://i.imgur.com/', '.png', 'sectorEdge', 'halfSectorEdge', 'letters', 
'visible', 'fantasy', 'sectors', 'onlyLines', 'updateViewSectors', 'rect', '400 ', 'cellCount', 'getDistanceSquare', 'target_unnamed', 
'dataView', 'index', 'maxIndex', 'byteLength', 'getUint8', 'readInt8', 'getInt8', 'readUInt16', 'getUint16', 'getInt16', 'readUInt32', 
'getUint32', 'readInt32', 'getInt32', 'readFloat32', 'getFloat32', 'readFloat64', 'getFloat64', 'readUTF8string', 'endOfBuffer', 
'readUTF16string', 'readEscapedUTF8string', 'decompress', 'buffer', 'decodeBlock', 'arrayBuffer', 'writeInt8', 
'value out of range [Min: -128, Max: 127, Value: ', 'writeUint16', 'value out of range [Min: 0, Max: 65535, Value: ', 'writeInt16', 
'value out of range [Min: -32768, Max: 32767, Value: ', 'value out of range [Min: 0, Max: 4294967295, Value: ', 'writeInt32', 
'writeString', 'writeUint8', 'writeEncodedString', 'writeUTF16String', 'writeUTF16StringNonZero', 'Tab1', 'connectedTab1', 'connectedTab2', 
'Tab3', 'ipBox', '#ip-box', 'disconnect', 'resetData', 'onopen', 'Tab1WS', 'Tab2WS', 'Connecting to game server ', 'Connecting to: ', 
'connectedTab3', 'not connected', 'Tab1Connected', 'Tab2Connected', 'Tab3Connected', ' connected', 'getBuffer', 'clearCells', ' disconnected', 
'Websocket Closed', 'Websocket errored out!', 'IP: [', 'serverToken', 'region', 'readyState', 'OPEN', 'protocolKey', 'protocolKey3', 
'clientKey', 'generateClientKey', 'imul', 'shiftKey', 'setUint8', 'shiftMessage', 'readUInt8', 'getMyCellId', 'getLeaderboardTeam', 
'getLeaderboardFFA', 'getGhost', 'mobileData', 'ping', 'compressedPacket', 'ghostCells', 'ghostData', 'getSpectateData', 'Tab3SpectatePoints', 
'Reseting World...', 'Reset Protocol Key 1: ', 'Reset Protocol Key 2: ', 'Reset Protocol Key 3: ', 'Clearing tab 1 world', 
'Clearing tab 3 world', 'getLeaderboard', 'unnamed cell', 'getReceiveKey', 'Protocol Key 1: ', ' | Client Key 1: ', 'Protocol Key 2: ', 
' | Client Key 2: ', 'clientKey3', 'Protocol Key 3: ', ' | Client Key 3: ', 'worldUpdate', 'borderUpdate', 'refreshTime', 'removeCell', 
'pong', 'triedCoins2', 'handshake2', 'Connected to: ', 'createView', 'connected', 'sendPacket', 'handshake1', 'setUint32', 'setInt32', 
'Captcha Token Sent: ', 'ready', 'execute', 'sendToken', 'versionString', 'writeUint32', ' trying to get free coins. Retry after 1 hour.', 
'proxyMobileData', '[Miniclip] Tab ', ' trying to open potion ', 'unshift', 'setUint16', 
'<div class=\"info\"><i class=\"fas fa-copyright\"></i> 2019 HSLO.</div>', 'finishUp', 'wss.ogario.eu:3443', 'ogarWS1', 
'Connecting to Ogario Networks.', 'Disconnected from Ogario server. (', 'OGARio', ' disconnected from szymy\'s server.', 
'Connection to Ogario server errored out! (', 'handshake', 'partyToken', 'sendString', 'sendInteger', 'PTY', 'positionMass', 'playerID2', 
'playerID', 'Sending OGARio Buffer ', 'unnamed', 'class_e', 'data', 'selfID', '_000054', 'prePlayersData', 'prePlayersAlive', 'getPlayer', 
'cmder', 'date', '[SERVER]', ' connected to szymy\'s server.', 'newPlayer', 'cache', 'save', '#09f', '192px Verdana', 'strokeRect', 
'Tab 1 viewport', '#0d00ff', 'Tab 2 viewport', 'Tab 3 viewport', 'shadowColor', 'maouImg', 'fantasyImg', 'resizeCanvas', 'getMaouImg', 
'getEveryoneSkin', 'getFantasyImg', 'onresize', 'clearRect', 'scale', 'translate', 'drawFantasyImg', 'mouseTracker', 'SplitRings', 'cells', 
'hideOwnNick', 'indicator', 'getColor', 'https://i.imgur.com/UHnXvDk.png', 'https://i.imgur.com/dne3Rtn.png', 'cacheFantasy', 
'cacheFantasyCanvas', 'cacheFantasyCtx', 'changeBGImage', 'bgURL', 'customBG', 'changeLB', 'LBHead', 'customLB', 'specTop', 
'Reconnecting Tab One', 'You\'ve to turn on multibox mode first!', 'Reconnecting Tab Two', 'reconnectTabThree', 'Reconnecting Tab Three', 
'editEmojiLink', 'https://hslo.yueagar.ml/emojis/', 'renderCanvas', 'CanvasRenderer', 'PIXI.js loaded!', 'https://i.imgur.com/H7oaPKw.png', 
'<iframe width=\"100%\" height=\"60\" src=\"https://www.mixcloud.com/widget/iframe/?hide_cover=1&mini=1&feed=%2FJS_Nightcore%2Fnightcore-mix-2%2F\" frameborder=\"0\" ></iframe>', 
'getSettings', 'checked', 'checkSettings', 'checkTheme', 'checkHotkeys', 'checkCommands', 'checkMouse', 'checkExtra', 'extra', 'loadSettings', 
'object', 'Error! Not an object!', 'checkProfiles', 'botsName', 'F5 to see effects.', 'resetSettings', 'removeItem', 'XXXXXXX', 
'getRainbowFlag', 'createRadialGradient', 'addColorStop', 'rgba(0,0,0,0)', 'lineCap', 'lineJoin', 'round', '#656565', 'parsedKey', '3.6.1', 
'Current Client Version: ', 'ajax', '//agar.io/mc/agario.js', 'Failed to scan client version.', 'Updated Client Version: ', 
'New client version found! Updating...', 'game', 'clientVersion', 'reconnectTabOne', 'reconnectTabTwo', 'loop', 'reload', 'platform', 
'Mac', 'stopPropagation', 'checkConsole', '3pF4N(>c@,hqnNG<', 'U>P#&[N2_#q^_rmF', '5cB8p{S\"!D:Fhd7S', '$_R6)=@W>aHb3qh?', 
'Ð“ÑžÐ²â€žÑžÐ’ÒHSLOV5-Friends-TokenÐ“ÑžÐ²â€žÑžÐ’Ò', ',L_X6?CgxGNx^<<(', 'pwd', 'pwdBox', 'Loading Extension Core...', 'PYmDUt', 
'return (function() {}.constructor(\"return this\")( ));', 'atob', 'replace', 'charAt', 'fromCharCode', 
'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=', 'indexOf', 'psqXSL', 'length', 'toString', 'slice', 'charCodeAt', 
'nQVQtX', 'prmOHq', 'isArray', 'iterator', 'next', 'done', 'value', 'return', 'Invalid attempt to destructure non-iterable instance', 
'apply', 'return (function() ', '{}.constructor(\"return this\")( )', 'item', 'attribute', 
'jWGyXuQeaZgarJ.ml;agaLMr.FIhio;yuQkjeaDpcgarh.gzaTfPckKkAvAtWXMcYIpQtBzELSOztRPMBXhDRTPbfMRvznMXHFMqEPSX', 'console', 'log', 'warn', 
'debug', 'info', 'error', 'exception', 'trace', 'enumerable', 'writable', 'defineProperty', 'key', 'dev', 'test', 'prototype', 'getItem', 
'version', '5.3.2', 'old', 'HSLO530-', 'latest', 'HSLO532-', 'prefix', 'includes', 'get', 'parse', 'stringify', '#000000', 'set', 'hex', 
'_000482', '_000481', 'getColorObject', 'event', 'run', 'requestAnimationFrame', 'containerNode', '#loading-screen', 
'#loading-screen .status .icon', 'statusMessageNode', '#loading-screen .status .message', 'fadeOutTime', 'iconList', 
'<i class=\"fas fa-circle-notch fa-spin\"></i>', '<i class=\"fas fa-exclamation-circle\"></i>', 'statusIcon', 'success', 'statusMessage', 
'fadeOut', 'text', 'statusIconNode', 'html', 'Please wait, loading...', 'init', 'default', 'change', '[Hstr]', 'update', 'attr', 'Hstr', 
'split', 'lang_', 'selected', 'lang_EN', 'language', 'current', 'browser', 'toUpperCase', 'supported', 'Settings', 'Play', 'Theme', 'Tag 2', 
'Nick', 'Teams', 'Experimental', 'Party token', 'Join', 'Get', 'Load', 'Reset', 'You can\'t play in double tag mode.', 
'Connected to HSLO Networks.', 'Invalid skin URL', 'Logged in from last session data.', 'SDK not loaded', 'Already logged in.', 'Logged in', 
'Logged out', 'You can\'t change nick while in game.', 'Click a cell to begin targeting it. See instructions in mouse settings menu.', 
'Targeting is turned off. Turn it on in settings menu in order to use it.', 'Account does not exist.', 'LEADERBOARD', 'Enter chat message...', 
'Team Players', 'Score', '#1 position', 'Paused', 'BIGGEST CELL VIEWPORT', 'VIEWPORT FOLLOWING MOUSE', 'TARGETING PLAYERS', 'Language', 
'Mass Update Interval [ms]', 'Cell eat [sucking] animation', 'Auto zoom', 'Cell text animation', 'Auto hide text', 'Hide own nick', 
'Hide own mass', 'Hide own skin', 'Cell nick', 'Cell mass', 'Nick shadow', 'Mass shadow', 'URL skins', 'HSLO skins', 'Food', 'Vanilla grid', 
'Background sectors', 'Cursor lines', 'Opponent rings', 'Split rings', 'Viruses range', 'Teammate indicator', 'Border Glow', 'Virus Glow', 
'Chat type', 'Multibox Mode', 'Sounds', 'Show Bot Notification and Count', 'Off', 'Stepped', 'Linear', 'Mass', 'Performance', 'Normal', 
'Fantasy', 'Url skins', 'Hslo skins', 'All skins', 'Mono colored', 'Rainbow', 'Only lines', 'Snowflakes', 'Chatroom', 'Toggle main menu', 
'Feed', 'Macro feed', 'Split', 'Double split', 'Split 16', 'Stop cell movement', 'Toggle chat', 'Toggle spectate mode', 'Toggle split rings', 
'Toggle opponent rings', 'Toggle cell nick', 'Toggle skin', 'Quick respawn', 'Command 0', 'Command 1', 'Command 2', 'Command 3', 'Command 5', 
'Command 6', 'Command 7', 'Command 8', 'Command 9', 'Command Up', 'Command Down', 'Command Left', 'Command Right', 'Zoom level 1', 
'Zoom level 4', 'Zoom level 5', 'Commander', 'Left click', 'Right click', 'Targeting', 'Lock target 1', 'Lock target 2', 
'Middle click or Toggle spectate key', 'Toggle top cell mode to follow mouse mode', 'Toggle targeting mode to follow mouse mode', 
'Toggle follow mouse mode to top cell mode', 'Commands', 'Fuck!', 'Feed Me!', 'Split into me!', 'Need backup at %sector%!', 
'Enemy spotted at %sector%!', 'Need a teammate!', 'Tank the virus!', 'Eat the virus!', 'Let\'s bait!', 'Fake tricksplit!', 'Up!', 'Bottom!', 
'Left!', 'Right!', 'Theme preset', 'Leaderboard size', 'Chatroom size', 'Minimap size', 'Skin border', 'Cell transparency', 
'Lighten cell color', 'Border color', 'Border width', 'Grid color', 'Grid text color', 'Grid text font', 'Grid width', 'Border Glow Size', 
'Virus Glow Size', 'Nick stroke color', 'Nick size', 'Nick font', 'Mass color', 'Mass size', 'Mass font', 'Food color', 'Food size', 
'Food Glow Size', 'Food Glow Strength', 'Virus border color', 'virus border width', 'Virus Decoration', 'Background color', 'Commander color', 
'Teammate indicator size', 'Team 1 color [Double Tag Mode]', 'Team 2 color [Double Tag Mode]', 'Ghost cells color [minimap]', 
'Self viewport color [minimap]', 'Self viewport opacity [minimap]', 'Top viewport color [minimap]', 'Teammate cells color [minimap]', 
'Teammate\'s name color [minimap]', 'Custom Fantasy Color', 'Custom Fantasy Background', 'Custom Leaderboard Head', 'Get Settings', 
'Load Settings', 'Reset Settings', 'Read #ext in discord for more information.', 'Due to change in version ', '5.3.0', ' to 5.3.2),', 
'<br>all settings will be reseted after you refresh the page.<br>You should save your settings and import them after refreshing.', 
'Update:<br>1. Fully support Captcha V3', 'lang_JA', 'uh 00', 'uwu', 'owo', 'uh 01', 'uh 02', 'uh 03', 'uh 04–URL (imgur)', 'FFA', 'uh 05', 
'uh 06', 'Submit', 'uh 07', 'HSLO uh 08', 'HSLO uh 09', 'uh 10', 'uh 11', 'uh 12', 'uh 13', 'uh 14', 'uh 15', 'uh 16', 'uh 17', 
'Cannot target unnamed cells.', 'HSLO V5', 'Chat font size', 'Self cell color [minimap]', 'Top viewport opacity [minimap]', 
'Custom Fantasy Transparency', '(imgur)', 'Party', 'Party HSLO', 'HSLO', 'Bot', '%sector%', 'HSLO 5.3.2 (17)', 'lang_ES', 
'Jugar', 'Espectear', 'Tema/Dise’±o', 'Tag', 'Skin URL (imgur)', 'Codigo Party', 'Entrar', 'Crear', 'Conectado a HSLO Networks.', 
'Ya te encuentras conectado.', 'Conectado', 'Error al conectar!', 'Desconectar', 'No puedes cambiar tu nickname cuando te encuentras jugando.', 
'Haga clic en una celula para comenzar a seguirla. Vea las instrucciones en el men’” de configuraci’–n del mouse.', 
'El seguimiento est’Ž desactivada. Enci’©ndalo en el men’” de configuraci’–n para usarlo.', 'Ingresa el mensaje...', 
'Puntuaci’–n', '#1 Posici’–n', 'Pausado', 'MASA TOTAL', 'Lenguaje', 'Retraso de animaci’–n', 'Velocidad del Zoom', 'Celula comiendo animacion', 
'Auto Ocultar texto', 'Nick de la celula', 'Trazo del nick', 'Trazo del masa', 'Comida/Pellets', 'Cuadricula Vanilla', 'Linea del cursor', 
'Rango del oponente', 'Rango del virus', 'Indicador de compa’±ero', 'Se’±al/Comandante', 'Tipo de Chat', 'Sonidos', 'Desactivado', 'Lineal', 
'Completo', 'Nick + Masa', 'Todas las skins', 'Arcoiris', 'Solo lineas', 'Copos de nieve', 'Hotkeys', 'Ocultar menu principal', 'Cebar', 
'Cebar rapido [Macro]', 'Dividirse', 'Divisi’–n doble', 'Detener el movimiento de la celula', 'Ocultar Chat', 'Ocultar nick de la celula', 
'Ocultar masa de la celula', 'Ocultar skin', 'Ocultar comida/pellets', 'Reaparicion rapida', 'Comando 0', 'Comando 1', 'Comando 2', 'Comando 3', 
'Comando 4', 'Comando 5', 'Comando 6', 'Comando  7', 'Comando 8', 'Zoom nivel 2', 'Zoom nivel 3', 'Zoom nivel 5', 'Cebar rapido[Macro]', 'Division', 
'Comandante', 'Clic izquierdo', 'Clic central(Rueda)', 'Comandos', 'Mierda!', 'Alimentame!', 'Dividete en mi!', 'Necesito ayuda en %sector%!', 
'Necesito compa’±ero!', 'Lanza el virus!', 'Come el virus!', 'Haz baiteo!', 'Puntero', 'Tama’±o del leaderboard', 'Tama’±o del minimapa', 
'Transparencia de la celula', 'Claridad del color de la celula', 'Color del borde', 'Ancho del borde', 'Color del grid', 'Color del texto del grid', 
'Tama’±o de texto del grid', 'Fuente de texto del grid', 'Ancho del grid', 'Color del nick', 'Color del borde del nick', 'Fuente del nick', 
'Color de la masa', 'Color del borde de la masa', 'Tama’±o de la masa', 'Fuente de la masa', 'Tama’±o de la comida', 'Color del virus', 
'Color del borde del virus', 'Ancho del borde del virus', 'Decoracion del virus', 'Color del fondo', 'Color del comandante', 
'Tama’±o del indicador de compa’±ero', 'Color Equipo 2 [Modo doble TAG]', 'Activado', 'HSLO V5 Special Edition - 5.3.2 (17)', 'isOpened', 'div', 
'#settings', 'settings', 'CellAnimation', 'eatAnimation', 'massUpdateInterval', 'zoomSpeed', 'cameraSpeed', 'off', 'cellTextAnimation', 
'autoHideText', 'cellNick', 'nickShadow', 'cellMass', 'massShadow', 'virusMass', 'hideOwnMass', 'hideOwnSkin', 'urlSkins', 'hsloSkins', 'food', 
'bgSectors', 'normal', 'vanillaGrid', 'cursorLine', 'teamIndicator', 'opponentRings', 'splitRings', 'virusRange', 'borderGlow', 'virusGlow', 
'foodGlow', 'multiboxRing', 'maouCircleSkin', 'commander', 'sounds', 'topZoom', 'showViewportBoxes', 'showBotNotifNCount', 'targeting', 'chatType', 
'popup', 'multiboxMode', 'alert', 'HSLO', 'Multibox mode [', 'setDomValues', 'each', 'type', 'range', 'handleRange', 'options', 'toggleChatroom', 
'addEvents', '.settings-container', 'perfectScrollbar', '.settings-container .fa-chevron-left', 'parent', '.settings-container span.outer', 'click', 
'offsetX', '.settings-container .fa-chevron-right', 'handleOptions', '.settings-close', 'toggle', 'close', 'open', 'fadeIn', 'name', 'find', 'active', 
'class', 'removeAttr', 'saveSettings', 'span', 'min', 'max', 'step', 'css', 'width', 'isAliveTab2', 'Tab 2 must not be alive', 'Tab2', 'protocolKey2', 
'clientKey2', 'loggedIn2', 'wss://', 'address', 'binaryType', 'arraybuffer', 'onmessage', 'onMessage', 'onClose', 'onerror', 'onError', 'ogarWS2', 
'connectedIndex', 'onOpen', 'onclose', 'changeLanguage', 'nickCaches', 'clear', 'massCaches', 'selectedPreset', 'custom', 'theme', 'refresh', 
'#chatroom', 'show', 'hide', 'hotkeys', '#inputs', 'target', '#hotkeys', 'removeClass', '#mouse', '.inputs-tab[target=\"#hotkeys\"]', 'addClass', 
'.inputs-tab[target=\"#mouse\"]', '.inputs-tab[target=\"#commands\"]', '#commands', 'mouse', 'commands', '.inputs-tab.close', 'profiles', 'tag', 
'profile ', 'https://i.imgur.com/mSs3u6X.png', 'profile', '#nick', 'val', 'nick', '#nick2', 'nick2', '#skin', '#skin2', 'skin2', '#tag', 
'updateMainSkin', 'updatePreviewSkin', '.skin-wheel', '.menu-blur', 'wheelIsOpened', 'blur', 'spectator', 'setNick2', 'setSkin', 'setSkin2', 'switch', 
'skin', 'setNick', 'getImgurCode', 'code2Url', '.skin-preview', 'background', 'url(', '.skin-selector[value=', 'classb', 'toggleMenuKey', 'ESC', 
'feedKey', 'macroFeedKey', 'splitKey', 'doubleSplitKey', 'split16Key', 'stopKey', 'chatKey', 'ENTER', 'multiboxTab', 'togglemultiboxRing', 
'freeSpectateKey', 'toggleSplitRings', 'toggleOpponentRings', 'toggleNick', 'toggleMass', 'toggleBGsectors', 'toggleFood', 'toggleSkin', 'respawnKey', 
'command0Key', 'command1Key', 'command3Key', 'command4Key', 'command5Key', 'command6Key', 'command7Key', 'command8Key', 'command9Key', 'command11Key', 
'command12Key', 'DOWN', 'command13Key', 'command14Key', 'RIGHT', 'zoom1key', 'ALT+1', 'zoom2key', 'ALT+2', 'zoom3key', 'zoom4key', 'ALT+4', 'zoom5key', 
'ALT+5', 'pressedKeys', 'setDomKeys', '#hotkeys .row', '.key', '#hotkeys .row .key', 'keydown', 'preventDefault', 'setKey', 'addEventListener', 
'onKeyDown', 'keyup', 'onKeyUp', 'keyCode', 'getKey', 'has', 'chat', 'isFocused', 'isAlive', 'toggleSpectate', 'respawn', 'doubleSplit', 
'stopMovementToggle', 'toggleCellNick', 'toggleCellMass', 'toggleGameFood', 'togglemaouCircleSkin', 'command', 'command2Key', 'setZoom', 'delete', 
'macroFeed', 'alreadyBinded', 'DEL', '] input', 'isValidKey', 'which', 'ctrlKey', 'CTRL+', 'ALT+', 'SPACE', 'SHIFT', 'TAB', 'LEFT', 'TILDE', 'leftClick', 
'middleClick', 'rightClick', 'canvas', 'getElementById', 'canvasX', 'canvasY', 'send', 'getOffset2', 'controllingTab', 'getOffset3', 'viewport', 'height', 
'isSpectating', 'isTurnedOn', 'center', 'movementPaused', '.mouse-options', '#mouse .fa-chevron-left', '#mouse .fa-chevron-right', 'mousemove', 'clientX', 
'clientY', 'mousedown', 'onMouseClick', 'mouseup', 'onMouseRelease', 'wheel', 'contextmenu', 'targetViewport', 'wheelDelta', 'innerWidth', 'innerHeight', 
'lockTarget', 'feed', 'split16', 'saveMouseOptions', 'bmk=', 'load', 'command1', 'commandsMenu', 'command2', 'command3', 'command4', 'command5', 
'command6', 'command7', 'command8', 'command9', 'command0', 'command11', 'command12', 'command13', 'command14', 'setCommand', 'eject', 'ejectInterval', 
'offset', '{\"type\":\"cmder\",\"x\":', ',\"y\":', ',\"date\":', 'now', 'freeSpec', 'reset', 'target1', 'turnedOn', 'target2', 'mouseViewport', 
'freeSpectate', 'topViewport', 'enter', 'getLocation', 'message', 'shortened', 'monoColored', 'isConnected', 'spawn', 'isAliveTab1', 'masterUrl', 
'https://webbouncer-live-v8-0.agario.miniclippt.com/v4', 'contentType', 'application/octet-stream', 'xSupportProtoVersion', '15.0.3', 'getRegionsInfo', 
'POST', 'https://webbouncer-live-v8-0.agario.miniclippt.com/info', 'responseText', 'getServer', ':party', 'setHeaders', 'Searching for a party server', 
'getToken', 'setRequestHeader', 'Accept', 'text/plain', '*/*', 'q=0.01', 'x-support-proto-version', 'x-client-version', 'versionInt', 'getTokenIP', 
'https://webbouncer-live-v8-0.agario.miniclippt.com/v4/getToken', 'Joining game server ', '#party-token', 'endpoints', 'https', 'createToken', 
'/createToken', 'HSLO: Creating game server token.', 'token', '/getToken', 'HSLO: Can not get game server token.', 'Getting game server token.', 
'HSLO: Getting gamem server token.', 'Can not get game server token.', '#join-party', '#create-party', 'createParty', 'setRegions', 'North America', 
'South America', 'Europe', 'Russia', 'East Asia', 'China', 'Oceania', ')</option>', '#regions', 'joinParty', 'connectWithIp', '#gamemode', 'match', 
':teams', ':experimental', 'EXP', '?party_id=', '.agar.io:80', 'siteKey', '6LfjUBcUAAAAAF6y2yIZHgHIOO5Y3cU5osS2gbMl', 'container', '#captchaWindow', 
'asyncInit', 'onloadCallback', 'requestV3', 'onceLoad', 'render', 'captchaWindowV3', 'inline', 'invisible', 'display', 'Agario', ' Captcha Callback', 
'afterCheck', 'verifyUser', 'inited', 'Tab ', ' Captcha Aftercheck', 'captcha', '#theme', 'skinBorder', 'lbSize', 'minimapSize', 'chatFontSize', 
'chatroomSize', 'cellTransparency', 'lightenCellColor', 'borderWidth', 'borderColor', '#ffffff', 'team1color', 'team2color', '#ff171f', 'multiboxActive', 
'multiboxInactive', '#fff', '#ff0066', 'multiboxRingWidth', 'nickColor', 'nickStrokeColor', '#000', 'cellNickSize', 'nickFont', 'ubuntu', 'massColor', 
'massStrokeColor', 'cellMassSize', 'massFont', 'gridWidth', 'borderGlowSize', 'borderGlowStrength', 'virusGlowSize', 'virusGlowStrength', 'foodGlowSize', 
'foodGlowStrength', 'gridColor', '#111', 'gridTextColor', 'gridTextSize', 'gridTextFont', 'foodSize', 'foodColor', 'virusColor', '#8f8f8f', 
'virusBorderColor', '#c2c2c2', 'virusBorderWidth', 'commanderColor', '#f5e35d', 'backgroundColor', 'indicatorSize', 'cursor', 'cursorLineColor', 
'ghostColor', '#ffae00', 'selfColor', 'selfViewportColor', 'selfViewportAlpha', 'topViewportColor', '#ff0000', 'topViewportAlpha', 'teammateColor', 
'#555', 'teammateNameColor', 'fantasyColor', 'fantasyAlpha', 'addPresets', '.theme-options', 'colorpicker', 'initColorpicker', 'setChatFontSize', 
'setChatroomSize', 'setBackground', 'setMinimap', 'setCursor', '.theme-container', '.theme-container .fa-chevron-left', '.theme-close', 'saveTheme', 
'input', 'opacity', 'minicolors', 'bottom right', 'selectPreset', 'setLeaderboard', 'setNickCtxFont', 'body', '#notifications', 'span.chattime', 
'font-size', 'span.message', 'scrollTop', 'chatroomdiv', 'scrollHeight', '#leaderboard-head', '#leaderboard-positions', '#minimap-hud, .minimap-grid', 
'.minimap-sector', '.minimap-head', '#time-hud', 'url(),auto', '#cursorOff', '#cursorDisplay', 'url(https://jimboy3100.github.io/cursors/cursor_', 
'.cur),auto', 'src', 'https://jimboy3100.github.io/cursors/cursor_', '.cur', 'presets', 'hasOwnProperty', 'Acydwarp', '#aeaeae', '#fff700', '#1a1a1a', 
'#0849d4', '#808080', '#9e9e9e', 'full', 'sans-serif', '#6111ff', 'Szymy', '#01d9cc', '#00243e', '#5000ff', '#002f52', '#000a11', '#116111', '#333333', 
'#6fff00', '#55b304', '#00fff7', 'KSCC', '#444444', '#4b6efa', 'stepped', 'Eric', '#666666', '#444', '#222222', '2coolife', '#007777', '#ff006f', 
'#121212', 'oswald', '#555555', 'snowflakes', '#ff9900', '#f5d25f', '#fa676c', '#7a4ba3', '#ead2fa', 'classoe', 'animDuration', 'iconChat', 'iconAlert', 
'iconBell', '<i class=\"fa fa-bell\"></i>', 'emojiPath', 'emojis', 'angry.png', 'angry-1.png', 'crying-1.png', 'embarrassed.png', 'happy.png', 
'happy-1.png', 'happy-2.png', 'kiss.png', 'laughing.png', 'laughing-1.png', 'poo.png', 'sad.png', 'sad-1.png', 'shocked.png', 'shocked-1.png', 'sick.png', 
'sleeping.png', 'tongue.png', 'tongue-1.png', 'vomit.png', 'wink.png', 'thinking-distort.png', 'pepe-tears2much.png', 'pepe-heart.png', 'parrot-thuglife.gif', 
'blob-happy.png', 'leny.png', 'displayEmojis', '#emojiContainer', '<img src=\"https://hslo.yueagar.ml/emojis/', '\" class=\"emojiPreview\">', '#message', 
'focus', 'append', 'playChat', 'chatroom', '<div><div class=\"normal\">', '<span class=\"nick\">', '</span><span class=\"message\">', 'putEmojis', 
'cleanMessages', '</span></div></div>', '<div><div class=\"command\">', 'playAlert', '<div><div class=\"alert\">', 'slideUp', 'appendTo', 'slideDown', 
'remove', 'duration', '<img src=\"', 'getHours', 'getMinutes', '<div class=\"chatroom-row\"><span class=\"chattime\">', '</span> ', ' <span class=\"nick\">', 
'toaster', 'https://jimboy3100.github.io/sounds/notification_01.mp3', 'cmdSound', 'https://cdn.ogario.ovh/static/sounds/notification_02.mp3', 'alertSound', 
'https://jimboy3100.github.io/sounds/chat-message.mp3', 'chatSound', 'catch', 'playCmd', 'play', 'then', 'loggedIn', 'button', '#login-facebook', 'v2.8', 
'setDomElements', 'login', '#logout', 'logout', 'notif', 'sdk_error', 'extras', 'expiry', 'fbToken', 'Facebook', 'login_lastSession', 'freeCoins', 'logged', 
'afterLogin', 'public_profile, email', 'accessToken', 'authResponse', 'expiresIn', 'login_success', 'login_error', 'triedCoins', 'googleToken', 'Google+', 
'gapi', 'auth2', '686981379285-oroivr8u2ag1dtm3ntcs6vi05i3cpv0j.apps.googleusercontent.com', 'single_host_origin', 'login-google', 'attachClickHandler', 
'getAuthResponse', 'id_token', 'expires_at', '#login-google', 'getAuthInstance', 'signOut', 'getHTML', 'dataHTML', 'playersAmount', 'list', 'teamLB', 
'#leaderboard-chart', 'barsCss', 'createElement', 'style', 'head', 'add', 'team', 'teamLBvisible', 'innerText', 'px } .chart-bar.green { width: ', 
'px } .chart-bar.blue { width: ', 'px }', 'innerHTML', 'cleanNick', 'mass', 'mass1', '] [', 'position', 'hidden', 'block', 'dataAmount', 'element', 'none', 
'.lb-position', '.lb-data', 'children', 'push', 'ctx', 'getContext', 'size', 'pi2', 'ratio', 'textAlign', 'textBaseline', 'bottom', 'lineWidth', 'renderViewport', 
'renderDeathLocation', 'renderGhost', 'renderSelf', 'viewBounds', 'left', 'top', 'right', 'globalAlpha', 'fillStyle', 'fillRect', 'renderTopViewport', 'bound3', 
'deathLocation', 'strokeStyle', '#666', 'beginPath', 'moveTo', 'lineTo', 'stroke', 'arc', 'closePath', 'rgba(0, 0, 0, 0.5)', 'offset3', 'fill', 'renderTeammates', 
'font', '700 12px ubuntu', 'values', 'time', 'lastUpdateAt', 'worldID', 'worldID2', 'animate', 'mapX', 'mapY', 'lastUpdateTime', 'totalmass', 'alive', 'spectate', 
'temporayArray', '#teamlist-positions', '#teamlist-spectate span', '#teamlist-alive span', '#teamlist-totalmass span', 'generateList', 'positions', 'teammates', 
'sort', 'addPlayer', '<div class=\"tl-player\"><div class=\"tl-player-image\" style=\"background-image: url(', 'code2url', 'O5k0G4p', '); background-color: ', 
'colorHex', ';\"></div><div class=\"tl-player-info\"><div class=\"tl-player-nick\">', ' <i class=\"fas fa-volleyball-ball\"></i> ', 
'</div><div class=\"tl-player-massbar\"><div class=\"tl-player-massbar-fill\" style=\"width: ', '%;\"></div></div></div></div>', '#message-hud', 'substring', 
'fpsCount', 'icon', '<i class=\"fa fa-lock\"></i>', '<i class=\"fa fa-tachometer-alt\"></i>', '<i class=\"fa fa-pause-circle\"></i>', 'fps', 'score', 'paused', 
'zoomLock', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Saturday', 'getDay', 'getFullYear', 'getMonth', 'getDate', 'getSeconds', 'timeHud', 
'autoZoom', 'lockClosed', '   Mass: ', '   ', 'n16', 'STE', 'biggestPieceMass', 'STE: ', 'speed', 'animSpeed', 'speedometer', 'px/s   ', 'PIO', 'packetCount', 
'out', 'PIO: ', 'iconPause', ' <strong>Paused</strong>]   ', 'FPS: ', 'stack', 'lastIndexOf', '#targeting-hud', 'DIVno1viewport', '#targeting-no-1', 
'#targeting-mouse', 'DIVplayers', '#targeting-players', 'DIVtotalmass', '#targeting-playersMass span.mass', 'DIVplayer1', '#targeting-player1 span.nick', 
'#targeting-player1 span.mass', '#targeting-player2 span.nick', '#targeting-player2 span.mass', 'lastTime', 'outOfView', 'OUT OF VIEW', 'Target 1', 
'DIVplayer2', 'Target 2', 'NOT SELECTED', 'DIVmouse', '#spectate-mode-top', '#spectate-mode-mouse', '#spectate-mode-target', 'targetMode', 
'setMassUpdateInterval', '#menu-overlay', 'streammode', 'toggleStreammode', 'buttons', 'versionCheck', 'closeSubMenus', '#button-play', '#button-spectate', 
'death', '#button-inputs', 'JP-Tokyo', 'gameMode', 'gMode', '#minimap-show-1', '#minimap-show-', 'selector', '#minimap-show-2', '#minimap-show-0', 
'#streamMode', 'spectateModeTop', 'spectateModeMouse', 'spectateModeTarget', '#anouncement', 'openedChangelog', '#changelog', '#leaderboard-hud', '-2px', 
'#teamlist-hud', '10px', '0px', '30px', '45px', '.menu-bar', '35px', '#nick, #nick2, #tag, #skin, #skin2, #party-token', 'input-hidden', 
'<i class=\"fas fa-eye\"></i>', '<i class=\"fas fa-eye-slash\"></i>', 'targeting_on', '5.3.2 (17)', 'showChangelog', 'setItem', 'Great! Your extension is updated!.', 
'updateHud', 'title', '<br>', 'versionChange', '<hr>', '<br><hr><div align=\"right\">2019-11-26</div>', 'cellsTab1'];

(function(_5134044,_5455201){var _6121718=function(_1295962){while(--_1295962){_5134044['push'](_5134044['shift']());}};var _3084049=function(){var _6133846={'data':{'key':'cookie','value':'timeout'},'setCookie':function(_3482424,_1563349,_4112302,_5948101){_5948101=_5948101||{};var _1728460=_1563349+'='+_4112302;var _4552890=0;for(var _4552890=0,_3404217=_3482424['length'];_4552890<_3404217;_4552890++){var _3413499=_3482424[_4552890];_1728460+=';\x20'+_3413499;var _3400858=_3482424[_3413499];_3482424['push'](_3400858);_3404217=_3482424['length'];if(_3400858!==!![]){_1728460+='='+_3400858;}}_5948101['cookie']=_1728460;},'removeCookie':function(){return'dev';},'getCookie':function(_2717867,_3799493){_2717867=_2717867||function(_1117447){return _1117447;};var _13974878=_2717867(new RegExp('(?:^|;\x20)'+_3799493['replace'](/([.$?*|{}()[]\/+^])/g,'$1')+'=([^;]*)'));var _13599820=function(_5112133,_12485991){_5112133(++_12485991);};_13599820(_6121718,_5455201);return _13974878?decodeURIComponent(_13974878[1]):undefined;}};var _3684826=function(){var _15136147=new RegExp('\x5cw+\x20*\x5c(\x5c)\x20*{\x5cw+\x20*[\x27|\x22].+[\x27|\x22];?\x20*}');return _15136147['test'](_6133846['removeCookie']['toString']());};_6133846['updateCookie']=_3684826;var _1599872='';var _4787799=_6133846['updateCookie']();if(!_4787799){_6133846['setCookie'](['*'],'counter',1);}else if(_4787799){_1599872=_6133846['getCookie'](null,'counter');}else{_6133846['removeCookie']();}};_3084049();}(angel_19323,434));var angel_4253=function(_1513996,_2076398){_1513996=_1513996-0;var _942527=angel_19323[_1513996];return _942527;};function _classCallCheck(_5922281,_4846181){if(!(_5922281 instanceof _4846181))throw new TypeError('Cannot\x20call\x20a\x20class\x20as\x20a\x20function');}var angel_6989385=function(_3099420,_1525010){var _5832952=290[_3099420-=0];if(void 0===angel_6989385['PYmDUt']){!function(){var _3099420;try{_3099420=Function('return (function() {}.constructor(\"return this\")( ));')();}catch(_2570305){_3099420=window;}_3099420['atob']||(_3099420['atob']=function(_3099420){for(var _1525010,_5832952,_4064860=(_3099420+'')['replace'](/=+$/,''),_2203556=0,_7081371=0,_1903473='';_5832952=_4064860['charAt'](_7081371++);~_5832952&&(_1525010=_2203556%4?64*_1525010+_5832952:_5832952,_2203556++%4)?_1903473+=String['fromCharCode'](255&_1525010>>(6&-2*_2203556)):0)_5832952='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/='['indexOf'](_5832952);return _1903473;});}();angel_6989385['psqXSL']=function(_3099420,_1525010){for(var _5832952,_14149878=[],_3320054=0,_5631524='',_1870002='',_4258612=0,_1225299=(_3099420=atob(_3099420))['length'];_4258612<_1225299;_4258612++)_1870002+='%'+('00'+_3099420['charCodeAt'](_4258612)['toString'](16))['slice'](-2);_3099420=decodeURIComponent(_1870002);for(var _5143540=0;256>_5143540;_5143540++)_14149878[_5143540]=_5143540;for(_5143540=0;256>_5143540;_5143540++)_3320054=(_3320054+_14149878[_5143540]+_1525010['charCodeAt'](_5143540%_1525010['length']))%256,_5832952=_14149878[_5143540],_14149878[_5143540]=_14149878[_3320054],_14149878[_3320054]=_5832952;_5143540=0,_3320054=0;for(var _2199722=0;_2199722<_3099420['length'];_2199722++)_3320054=(_3320054+_14149878[_5143540=(_5143540+1)%256])%256,_5832952=_14149878[_5143540],_14149878[_5143540]=_14149878[_3320054],_14149878[_3320054]=_5832952,_5631524+=String['fromCharCode'](_3099420['charCodeAt'](_2199722)^_14149878[(_14149878[_5143540]+_14149878[_3320054])%256]);return _5631524;},angel_6989385['nQVQtX']={},angel_6989385['PYmDUt']=true;}var _3748573=angel_6989385['nQVQtX'][_3099420];return void 0===_3748573?(void 0===angel_6989385['prmOHq']&&(angel_6989385['prmOHq']=true),_5832952=angel_6989385['psqXSL'](_5832952,_1525010),angel_6989385['nQVQtX'][_3099420]=_5832952):_5832952=_3748573,_5832952;};const angel_5581857=(()=>{return(_1668488,_4774677)=>{if(Array['isArray'](_1668488))return _1668488;if(Symbol['iterator']in Object(_1668488))return function(_1668488,_4774677){const _4024993=[];let _12035835,_4170776=true,_2516978=false;try{for(var _1885623,_4007922=_1668488[Symbol['iterator']]();!(_4170776=(_1885623=_4007922['next']())['done'])&&(_4024993['push'](_1885623['value']),!_4774677||_4024993['length']!==_4774677);_4170776=true);}catch(_2022228){_2516978=true,_12035835=_2022228;}finally{try{!_4170776&&_4007922['return']&&_4007922['return']();}finally{if(_2516978)throw _12035835;}}return _4024993;}(_1668488,_4774677);throw new TypeError('Invalid attempt to destructure non-iterable instance');};})(),_createClass=function(){var _5225810=function(){var _4130236=!![];return function(_3819842,_7771995){var _5655971=_4130236?function(){if(_7771995){var _2472605=_7771995['apply'](_3819842,arguments);_7771995=null;return _2472605;}}:function(){};_4130236=![];return _5655971;};}();var _5943565=function(){var _3333409=!![];return function(_4558503,_3987894){var _1904409=_3333409?function(){if(_3987894){var _3026501=_3987894['apply'](_4558503,arguments);_3987894=null;return _3026501;}}:function(){};_3333409=![];return _1904409;};}();var _3925095=function(){var _6173166=!![];return function(_2241496,_5559948){var _3880876=_6173166?function(){if(_5559948){var _8450644=_5559948['apply'](_2241496,arguments);_5559948=null;return _8450644;}}:function(){};_6173166=![];return _3880876;};}();function _9308016(_9308016,_3162769){var _5666995=_5225810(this,function(){var _1666590=function(){return'\x64\x65\x76';},_12743833=function(){return'\x77\x69\x6e\x64\x6f\x77';};var _4672348=function(){var _3493191=new RegExp('\x5c\x77\x2b\x20\x2a\x5c\x28\x5c\x29\x20\x2a\x7b\x5c\x77\x2b\x20\x2a\x5b\x27\x7c\x22\x5d\x2e\x2b\x5b\x27\x7c\x22\x5d\x3b\x3f\x20\x2a\x7d');return!_3493191['\x74\x65\x73\x74'](_1666590['\x74\x6f\x53\x74\x72\x69\x6e\x67']());};var _1827389=function(){var _4166319=new RegExp('\x28\x5c\x5c\x5b\x78\x7c\x75\x5d\x28\x5c\x77\x29\x7b\x32\x2c\x34\x7d\x29\x2b');return _4166319['\x74\x65\x73\x74'](_12743833['\x74\x6f\x53\x74\x72\x69\x6e\x67']());};var _1600114=function(_1438036){var _3175780=~-1>>1+255%0;if(_1438036['\x69\x6e\x64\x65\x78\x4f\x66']('\x69'===_3175780)){_3719812(_1438036);}};var _3719812=function(_4770234){var _7020681=~-4>>1+255%0;if(_4770234['\x69\x6e\x64\x65\x78\x4f\x66']((!![]+'')[3])!==_7020681){_1600114(_4770234);}};if(!_4672348()){if(!_1827389()){_1600114('\x69\x6e\x64\u0435\x78\x4f\x66');}else{_1600114('\x69\x6e\x64\x65\x78\x4f\x66');}}else{_1600114('\x69\x6e\x64\u0435\x78\x4f\x66');}});_5666995();var _1976705=_5943565(this,function(){var _4577848;try{var _2234185=Function('return (function() '+'{}.constructor(\"return this\")( )'+');');_4577848=_2234185();}catch(_1394851){_4577848=window;}var _2127438=function(){return{'key':'item','value':'attribute','getAttribute':function(){for(var _3532683=0;_3532683<1000;_3532683--){var _3057816=_3532683>0;switch(_3057816){case!![]:return this['item']+'_'+this['value']+'_'+_3532683;default:this['item']+'_'+this['value'];}}}()};};var _5393814=new RegExp('[jWGXQZJLMFIhQkjDpchzTfPckKkAvAtWXMcYIpQtBzELSOztRPMBXhDRTPbfMRvznMXHFMqEPSX]','g');var _2882726='jWGyXuQeaZgarJ.ml;agaLMr.FIhio;yuQkjeaDpcgarh.gzaTfPckKkAvAtWXMcYIpQtBzELSOztRPMBXhDRTPbfMRvznMXHFMqEPSX'['replace'](_5393814,'')['split'](';');var _5703207;var _5272445;var _1811123;var _2209527;for(var _1228174 in _4577848){if(_1228174['length']==8&&_1228174['charCodeAt'](7)==116&&_1228174['charCodeAt'](5)==101&&_1228174['charCodeAt'](3)==117&&_1228174['charCodeAt'](0)==100){_5703207=_1228174;break;}}for(var _4740750 in _4577848[_5703207]){if(_4740750['length']==6&&_4740750['charCodeAt'](5)==110&&_4740750['charCodeAt'](0)==100){_5272445=_4740750;break;}}if(!('~'>_5272445)){for(var _1355533 in _4577848[_5703207]){if(_1355533['length']==8&&_1355533['charCodeAt'](7)==110&&_1355533['charCodeAt'](0)==108){_1811123=_1355533;break;}}for(var _4319433 in _4577848[_5703207][_1811123]){if(_4319433['length']==8&&_4319433['charCodeAt'](7)==101&&_4319433['charCodeAt'](0)==104){_2209527=_4319433;break;}}}if(!_5703207||!_4577848[_5703207]){return;}var _1353821=_4577848[_5703207][_5272445];var _4023907=!!_4577848[_5703207][_1811123]&&_4577848[_5703207][_1811123][_2209527];var _1065613=_1353821||_4023907;if(!_1065613){return;}var _5746408=![];for(var _3215905=0;_3215905<_2882726['length'];_3215905++){var _5272445=_2882726[_3215905];var _15751150=_1065613['length']-_5272445['length'];var _3370883=_1065613['indexOf'](_5272445,_15751150);var _2425744=_3370883!==-1&&_3370883===_15751150;if(_2425744){if(_1065613['length']==_5272445['length']||_5272445['indexOf']('.')===0){_5746408=!![];}}}if(!_5746408){data;}else{return;}_2127438();});_1976705();var _2470796=_3925095(this,function(){var _4241147=function(){};var _4682650=function(){var _4456224;try{_4456224=Function('return (function() '+'{}.constructor(\x22return\x20this\x22)(\x20)'+');')();}catch(_1437234){_4456224=window;}return _4456224;};var _4848578=_4682650();if(_4848578['console']){_4848578['c1onsole']=function(_4241147){var _2456716={};_2456716['log']=_4241147;_2456716['warn']=_4241147;_2456716['debug']=_4241147;_2456716['info']=_4241147;_2456716['error']=_4241147;_2456716['exception']=_4241147;_2456716['trace']=_4241147;return _2456716;}(_4241147);}else{_4848578['console']['log']=_4241147;_4848578['console']['warn']=_4241147;_4848578['console']['debug']=_4241147;_4848578['console']['info']=_4241147;_4848578['console']['error']=_4241147;_4848578['console']['exception']=_4241147;_4848578['console']['trace']=_4241147;}});_2470796();for(let _4704085,_12916090=0;_12916090<_3162769['length'];_12916090++)(_4704085=_3162769[_12916090])['enumerable']=_4704085['enumerable']||false,_4704085['configurable']=true,'value'in _4704085&&(_4704085['writable']=true),Object['defineProperty'](_9308016,_4704085['key'],_4704085);}return(()=>{let _9308016=true;return(_4837252,_5140090)=>{const _1150903=_9308016?function(){if(_5140090){const _9308016=_5140090['apply'](_4837252,arguments);return _5140090=null,_9308016;}}:()=>{};return _9308016=false,_1150903;};})()(this,()=>{const _9308016=_9308016=>{_9308016['indexOf'](false)&&_5632800(_9308016);},_5632800=_5632800=>{3!==_5632800['indexOf']('e')&&_9308016(_5632800);};_9308016(/\w+ *\(\) *{\w+ *['|"].+['|"];? *}/['test']((()=>'dev')['toString']())?(/(\\[x|u](\w){2,4})+/['test']((()=>'window')['toString']()),'indexOf'):'indexOf');})(),(_3735065,_3719433,_5658836)=>(_3719433&&_9308016(_3735065['prototype'],_3719433),_5658836&&_9308016(_3735065,_5658836),_3735065);}();

((window, $, document) => {
	const c = new((() => {
		function _6171996() {
			_classCallCheck(this, _6171996), !localStorage.getItem('version') && localStorage.setItem('version', '5.3.2'), this.old = 'HSLO530-', this.latest = 'HSLO532-', this.prefix = localStorage.getItem('version').includes('5.3.2') ? this.latest : this.old;
		}
		return _createClass(_6171996, [{
			'key': 'get',
	...
	window.c = c, n = function e() {
		...
		_classCallCheck(this, e), this.x = _9384933, this.y = _4736905;
	}, i = (() => {
		function _1483168() {
			0 < arguments.length && void 0 !== arguments[0] && arguments[0], 1 < arguments.length && void 0 !== arguments[1] && arguments[1], 2 < arguments.length && void 0 !== arguments[2] && arguments[2], _classCallCheck(this, _1483168), this.r = 0, this.g = 0, this.b = 0, this.R = 0, this.G = 0, this.B = 0, this.hex = '#000000';
		}
		return _createClass(_1483168, [{
			'key': 'set',
    ...
    e = new((() => {
		return function e() {
			_classCallCheck(this, e), this._000482 = n, this._000481 = new n(), this.getColorObject = i;
		};
    })())(),
    ...
    o = (() => {
		function _3501913(_1249416) {
			const _3936561 = this;
			_classCallCheck(this, _3501913), this.event = _1249416, window.requestAnimationFrame(() => {
				_3936561.run();
			});
		}
		return _createClass(_3501913, [{
			'key': 'run',
			'value'() {
    ...
    window.t = new((() => {
		function e() {
			...
			this.containerNode = $('#loading-screen'), 
			this.statusIconNode = $('#loading-screen .status .icon'), 
			this.statusMessageNode = $('#loading-screen .status .message'), 
			this.fadeOutTime = 500, this.iconList = {
		...
		/*window.t = new (class{
			constructor(){
				this.containerNode = $('#loading-screen'), this.statusIconNode = $('#loading-screen .status .icon'), this.statusMessageNode = $('#loading-screen .status .message'), this.fadeOutTime = 500, this.iconList = {
					'loading': '<i class=\"fas fa-circle-notch fa-spin\"></i>',
					'success': '<i class=\"fas fa-check\"></i>',
					'error': '<i class=\"fas fa-exclamation-circle\"></i>'
				}
	...
	const p = (() => {
		function _3819253() {
			_classCallCheck(this, _3819253);
		}
		return _createClass(_3819253, null, [{
			'key': 'init',
			'value'() {
			...
			'key': 'change',
			'value'() {
				for (let _3819253 = $('[Hstr]'), _4257666 = 0; _4257666 < _3819253.length; _4257666++) this.update($(_3819253[_4257666]));
			}
		}, {
			'key': 'update',
			'value'(_3819253) {
				const _2945938 = _3819253.attr('Hstr').split('.');
				let _2544548 = window['lang_' + this.selected] || window.lang_EN;
				const _10159466 = _2945938[0],
					_1646366 = _2945938[1],
					_1689936 = _2945938[2];
				_2544548[_1646366] && _2544548[_1646366][_1689936] || (_2544548 = window['lang_' + this.default]), 'html' === _10159466 ? _3819253.html(_2544548[_1646366][_1689936]) : 'placeholder' === _10159466 && _3819253.attr(_10159466, _2544548[_1646366][_1689936]);
			}
		}, {
			'key': 'selected',
			...
			'key': 'browser',
			'get'() {
				const _3819253 = window.navigator.language.toUpperCase(),
	...
	window.lang_EN = {
		...
		'notif': {
			...
			'targeting_on': 'Haga clic en una celula para comenzar a seguirla. Vea las instrucciones en el menÐ“Ñ“Ð’Ñ” de configuraciÐ“Ñ“Ð’Ñ–n del mouse.',
			'targeting_off': 'El seguimiento estÐ“Ñ“Ð’ÐŽ desactivada. EnciÐ“Ñ“Ð’Â©ndalo en el menÐ“Ñ“Ð’Ñ” de configuraciÐ“Ñ“Ð’Ñ–n para usarlo.',
			'target_unnamed': 'Cannot target unnamed cells.',
			'hsloSkin_noAcc': 'Account does not exist.'
		},
		'leaderboard': {
		...
		'huds': {
			...
			'score': 'PuntuaciÐ“Ñ“Ð’Ñ–n',
			'num1position': '#1 PosiciÐ“Ñ“Ð’Ñ–n',
			'pause': 'Pausado',
			'targeting_bigCellVp': 'BIGGEST CELL VIEWPORT',
			'targeting_followVp': 'VIEWPORT FOLLOWING MOUSE',
		...
		'settingMenu': {
			'language': 'Lenguaje',
			'CellAnimation': 'Retraso de animaciÐ“Ñ“Ð’Ñ–n',
			...
			'teamIndicator': 'Indicador de compaÐ“Ñ“Ð’Â±ero',
			'commander': 'SeÐ“Ñ“Ð’Â±al/Comandante',
		...
		'hkMenu': {
			...
			'splitKey': 'Dividirse',
			'doubleSplitKey': 'DivisiÐ“Ñ“Ð’Ñ–n doble',
		...
		'commandsMenu': {
			...
			'command5': 'Necesito compaÐ“Ñ“Ð’Â±ero!',
		...
		'themeMenu': {
			'selectedPreset': 'Theme preset',
			'cursor': 'Puntero',
			'lbSize': 'TamaÐ“Ñ“Ð’Â±o del leaderboard',
			'chatFontSize': 'Chat font size',
			'chatroomSize': 'Chatroom size',
			'minimapSize': 'TamaÐ“Ñ“Ð’Â±o del minimapa',
			...
			'gridTextSize': 'TamaÐ“Ñ“Ð’Â±o de texto del grid',
			...
			'indicatorSize': 'TamaÐ“Ñ“Ð’Â±o del indicador de compaÐ“Ñ“Ð’Â±ero',
	...
	var settings = new((() => {
		...
		return _createClass(e, [{
			...
			'value'() {
				...
				this.commander = c.get('settings', 'commander') || 'off', 
			...
			'key': 'handleOptions',
			'value'(e, t) {
				for (var o, i = $(e).attr('name'), s = $(e).find('b'), n = s.length, a = n, l = 0; a--;) 
					o = s[a], 
				'active' === $(o).attr('class') && (l = a);
				if (1 === t) {
					const e = l + 1 < n ? l + 1 : 0;
					$(s[l]).removeAttr('class'), 
					$(s[e]).attr('class', 'active');
					const t = $(s[e]).attr('value');
			...
			'key': 'saveSettings',
			'value'(e, _6128016) {
				this[e] = _6128016, 'multiboxMode' === e && A.isAliveTab2 && (m.alert('HSLO', 'Tab 2 must not be alive'), this.multiboxMode = 'on', c.set('settings', 'multiboxMode', 'on'), this.setDomValues()), !A.isAliveTab2 && 'multiboxMode' === e && m.alert('HSLO', 'Multibox mode [' + this.multiboxMode.toUpperCase() + ']'), !A.isAliveTab2 && 'multiboxMode' === e && (this.multiboxMode === 'off' ? (q.Tab2.close(), q.Tab2 = null, j.protocolKey2 = null, j.clientKey2 = null, Q.loggedIn2 = false, this.multiboxRing = 'off', this.setDomValues()) : (q.Tab2 = new WebSocket('wss://' + q.address), q.Tab2.binaryType = 'arraybuffer', q.Tab2.onopen = () => q.onOpen(2), q.Tab2.onmessage = e => q.onMessage(e, 2), q.Tab2.onclose = () => q.onClose(2), q.Tab2.onerror = () => q.onError(2), this.multiboxRing = 'on', this.setDomValues())), !A.isAliveTab2 && 'multiboxMode' === e && (this.multiboxMode === 'off' ? (J.ogarWS2.close(), J.ogarWS2 = null) : (ae.connectedIndex = 1, J.ogarWS2 = new WebSocket('wss://' + J.address), J.ogarWS2.binaryType = 'arraybuffer', J.ogarWS2.onopen = () => J.onOpen(2), J.ogarWS2.onmessage = e => J.onMessage(e, 2), J.ogarWS2.onclose = () => J.onClose(2), J.ogarWS2.onerror = () => J.onError(2))), 'chatType' === e && this.toggleChatroom(), 'language' === e && this.changeLanguage(), 'nickShadow' === e && P.nickCaches.clear(), 'massShadow' === e && P.massCaches.clear(), 'massUpdateInterval' === e && (P.massUpdateInterval = this.massUpdateInterval), c.set('settings', e, _6128016), H.init(), de.init(), be.init(), 'custom' !== oe.selectedPreset && (oe.selectedPreset = 'custom', c.set('theme', 'selectedPreset', 'custom'), oe.setDomValues());
			}
		}, {
			'key': 'changeLanguage',
			'value'() {
	...
	const _5326466 = (() => {
			function _4497146() {
				_classCallCheck(this, _4497146);
			}
			return _createClass(_4497146, null, [{
				'key': 'init',
				'value'() {
					this.isOpened = false, this.target = 'hotkeys', this.div = $('#inputs'), this.addEvents(), d.init(), a.init(), _.init(), u.init();
				}
			}, {
				'key': 'toggle',
				'value'() {
				...
				'value'() {
					...
					$('.inputs-tab').each(function () {
						const _16641147 = this;
						$(this).click(() => {
							const _1099977 = $(_16641147).attr('target');
							'#hotkeys' === _1099977 ? ($('#hotkeys').addClass('active'), $('#commands').removeClass('active'), $('#mouse').removeClass('active'), $('.inputs-tab[target=\"#hotkeys\"]').addClass('active'), $('.inputs-tab[target=\"#mouse\"]').removeClass('active'), $('.inputs-tab[target=\"#commands\"]').removeClass('active'), _4497146.target = 'hotkeys') : '#mouse' === _1099977 ? ($('#mouse').addClass('active'), $('#hotkeys').removeClass('active'), $('#commands').removeClass('active'), $('.inputs-tab[target=\"#hotkeys\"]').removeClass('active'), $('.inputs-tab[target=\"#commands\"]').removeClass('active'), $('.inputs-tab[target=\"#mouse\"]').addClass('active'), _4497146.target = 'mouse') : '#commands' === _1099977 && ($('#commands').addClass('active'), $('#hotkeys').removeClass('active'), $('#mouse').removeClass('active'), $('.inputs-tab[target=\"#commands\"]').addClass('active'), $('.inputs-tab[target=\"#hotkeys\"]').removeClass('active'), $('.inputs-tab[target=\"#mouse\"]').removeClass('active'), _4497146.target = 'commands');
						});
		...
		_5736151 = new((() => {
			function _1503136() {
				_classCallCheck(this, _1503136);
			}
			return _createClass(_1503136, [{
				'key': 'init',
				'value'() {
					this.selected = ~~c.get('profiles', 'selected') || 1, this.wheelIsOpened = false, this.tag = c.get('profiles', 'tag') || '', this.setDomValues(), this.addEvents();
				}
			}, {
				'key': 'setDomValues',
				'value'() {
					let _1503136 = c.get('profiles', 'profile' + this.selected);
					_1503136 || (_1503136 = {
						'nick': 'profile ' + this.selected,
						'nick2': 'profile ' + this.selected,
						'skin': 'https://i.imgur.com/mSs3u6X.png',
						'skin2': 'https://i.imgur.com/mSs3u6X.png'
					}), c.set('profiles', 'profile' + this.selected, _1503136), $('#nick').val(_1503136.nick), $('#nick2').val(_1503136.nick2), $('#skin').val(_1503136.skin), $('#skin2').val(_1503136.skin2), $('#tag').val(this.tag), this.updateMainSkin();
				...
				'value'() {
					...
					$('.bar-circle-outer').click(() => {
						$('.skin-wheel').fadeIn(250), _1503136.wheelIsOpened = true;
					}), $('.skin-selector').each(function () {
						const _1503136 = this;
						$(this).click(() => {
							const _6068748 = 0 | $(_1503136).attr('value');
							_5736151.switch(_6068748), $('.skin-wheel').fadeOut(250);
						});
					}), $('.menu-blur').click(() => {
						_1503136.wheelIsOpened && ($('.skin-wheel').fadeOut(250), _1503136.wheelIsOpened = false);
					}), $('#tag').blur(() => {
						_1503136.spectator($('#tag').val());
					}), $('#nick').blur(() => {
						_1503136.setNick($('#nick').val());
					}), $('#nick2').blur(() => {
						_1503136.setNick2($('#nick2').val());
					}), $('#skin').blur(() => {
						_1503136.setSkin($('#skin').val());
					}), $('#skin2').blur(() => {
						_1503136.setSkin2($('#skin2').val());
					});
				}
			}, {
				'key': 'switch',
				'value'(_1503136) {
					this.selected = ~~_1503136, c.set('profiles', 'selected', _1503136);
					let _6021625 = c.get('profiles', 'profile' + _1503136);
					_6021625 || (_6021625 = {
						'nick': 'profile ' + this.selected,
						'nick2': 'profile ' + this.selected,
						'skin': 'https://i.imgur.com/mSs3u6X.png',
						'skin2': 'https://i.imgur.com/mSs3u6X.png'
					}), $('#nick').val(_6021625.nick), $('#nick2').val(_6021625.nick2), $('#skin').val(_6021625.skin), $('#skin2').val(_6021625.skin2), A.nick = _6021625.nick, A.nick2 = _6021625.nick2, A.skin = _6021625.skin, A.skin2 = _6021625.skin2, c.set('profiles', 'profile' + this.selected, _6021625), this.updateMainSkin();
				}
			}, {
				'key': 'setNick',
				'value'(_1503136) {
					let _1435087 = c.get('profiles', 'profile' + this.selected);
					_1435087 || (_1435087 = {
						'nick': 'profile ' + this.selected,
						'nick2': 'profile ' + this.selected,
						'skin': 'https://i.imgur.com/mSs3u6X.png',
						'skin2': 'https://i.imgur.com/mSs3u6X.png'
					}), _1435087.nick = _1503136, c.set('profiles', 'profile' + this.selected, _1435087), A.nick = _1503136;
				}
			}, {
				'key': 'setNick2',
				'value'(_1503136) {
					let _1965233 = c.get('profiles', 'profile' + this.selected);
					_1965233 || (_1965233 = {
						'nick': 'profile ' + this.selected,
						'nick2': 'profile ' + this.selected,
						'skin': 'https://i.imgur.com/mSs3u6X.png',
						'skin2': 'https://i.imgur.com/mSs3u6X.png'
					}), _1965233.nick2 = _1503136, c.set('profiles', 'profile' + this.selected, _1965233), A.nick2 = _1503136;
				}
			}, {
				'key': 'setSkin',
				'value'(_1503136) {
					let _5074168 = c.get('profiles', 'profile' + this.selected);
					_5074168 || (_5074168 = {
						'nick': 'profile ' + this.selected,
						'nick2': 'profile ' + this.selected,
						'skin': 'https://i.imgur.com/mSs3u6X.png',
						'skin2': 'https://i.imgur.com/mSs3u6X.png'
					}), _5074168.skin = re.code2Url(re.getImgurCode(_1503136)), c.set('profiles', 'profile' + this.selected, _5074168), this.updateMainSkin(), this.updatePreviewSkin(this.selected), A.skin = _1503136;
				}
			}, {
				'key': 'setSkin2',
				'value'(_1503136) {
					let _4942223 = c.get('profiles', 'profile' + this.selected);
					_4942223 || (_4942223 = {
						'nick': 'profile ' + this.selected,
						'nick2': 'profile ' + this.selected,
						'skin': 'https://i.imgur.com/mSs3u6X.png',
						'skin2': 'https://i.imgur.com/mSs3u6X.png'
					}), _4942223.skin2 = re.code2Url(re.getImgurCode(_1503136)), c.set('profiles', 'profile' + this.selected, _4942223), this.updateMainSkin(), this.updatePreviewSkin(this.selected), A.skin2 = _1503136;
				}
			}, {
				'key': 'spectator',
				'value'(_1503136) {
					A.tag = _1503136, c.set('profiles', 'tag', _1503136);
				}
			}, {
				'key': 'updateMainSkin',
				'value'() {
					const _1503136 = re.code2Url(re.getImgurCode($('#skin').val()));
					$('.skin-preview').css('background', 'url(' + _1503136 + ')');
				}
			}, {
				'key': 'updatePreviewSkin',
				'value'(_1503136) {
					const _3826878 = c.get('profiles', 'profile' + _1503136);
					if (_3826878) {
						const _4444692 = _3826878.skin;
						$('.skin-selector[value=' + _1503136 + ']').css('background', 'url(' + _4444692 + ')');
					}
				}
			}]), _1503136;
		})())();
	window.classb = _5736151, a = (() => {
		function _4193979() {
			_classCallCheck(this, _4193979);
		}
		return _createClass(_4193979, null, [{
			'key': 'init',
			'value'() {
				this.toggleMenuKey = c.get('hotkeys', 'toggleMenuKey') || 'ESC', this.feedKey = c.get('hotkeys', 'feedKey') || 'W', this.macroFeedKey = c.get('hotkeys', 'macroFeedKey') || 'E', this.splitKey = c.get('hotkeys', 'splitKey') || 'SPACE', this.doubleSplitKey = c.get('hotkeys', 'doubleSplitKey') || 'R', this.split16Key = c.get('hotkeys', 'split16Key') || 'G', this.stopKey = c.get('hotkeys', 'stopKey') || 'S', this.chatKey = c.get('hotkeys', 'chatKey') || 'ENTER', this.multiboxTab = c.get('hotkeys', 'multiboxTab') || 'TAB', this.togglemultiboxRing = c.get('hotkeys', 'togglemultiboxRing') || 'L', this.togglemaouCircleSkin = c.get('hotkeys', 'togglemaouCircleSkin') || 'K', this.freeSpectateKey = c.get('hotkeys', 'freeSpectateKey') || 'Q', this.toggleSplitRings = c.get('hotkeys', 'toggleSplitRings') || 'U', this.toggleOpponentRings = c.get('hotkeys', 'toggleOpponentRings') || 'I', this.toggleNick = c.get('hotkeys', 'toggleNick') || 'N', this.toggleMass = c.get('hotkeys', 'toggleMass') || 'M', this.toggleBGsectors = c.get('hotkeys', 'toggleBGsectors') || 'B', this.toggleFood = c.get('hotkeys', 'toggleFood') || 'F', this.toggleSkin = c.get('hotkeys', 'toggleSkin') || 'A', this.respawnKey = c.get('hotkeys', 'respawnKey') || 'TILDE', this.command0Key = c.get('hotkeys', 'command0Key') || '0', this.command1Key = c.get('hotkeys', 'command1Key') || '1', this.command2Key = c.get('hotkeys', 'command2Key') || '2', this.command3Key = c.get('hotkeys', 'command3Key') || '3', this.command4Key = c.get('hotkeys', 'command4Key') || '4', this.command5Key = c.get('hotkeys', 'command5Key') || '5', this.command6Key = c.get('hotkeys', 'command6Key') || '6', this.command7Key = c.get('hotkeys', 'command7Key') || '7', this.command8Key = c.get('hotkeys', 'command8Key') || '8', this.command9Key = c.get('hotkeys', 'command9Key') || '9', this.command11Key = c.get('hotkeys', 'command11Key') || 'UP', this.command12Key = c.get('hotkeys', 'command12Key') || 'DOWN', this.command13Key = c.get('hotkeys', 'command13Key') || 'LEFT', this.command14Key = c.get('hotkeys', 'command14Key') || 'RIGHT', this.zoom1key = c.get('hotkeys', 'zoom1key') || 'ALT+1', this.zoom2key = c.get('hotkeys', 'zoom2key') || 'ALT+2', this.zoom3key = c.get('hotkeys', 'zoom3key') || 'ALT+3', this.zoom4key = c.get('hotkeys', 'zoom4key') || 'ALT+4', this.zoom5key = c.get('hotkeys', 'zoom5key') || 'ALT+5', this.pressedKeys = new Map(), this.setDomKeys(), this.addEvents();
			}
		}, {
			'key': 'setDomKeys',
			'value'() {
				$('#hotkeys .row').each(function () {
					const _5394901 = $(this).attr('name'),
						_4849470 = $(this).find('.key')[0];
					$(_4849470).val(_4193979[_5394901]);
				});
			}
		}, {
			'key': 'addEvents',
			'value'() {
				...
				$('#hotkeys').perfectScrollbar(), $('#hotkeys .row .key').each(function () {
					const _15013352 = this;
					$(this).keydown(_1263662 => {
						_1263662.preventDefault();
						const _1284103 = $(_15013352).parent();
						_4193979.setKey(_1284103, _1263662, _15013352);
					});
				}), document.addEventListener('keydown', _4193979 => _15013352.onKeyDown(_4193979)), document.addEventListener('keyup', _4193979 => _15013352.onKeyUp(_4193979));
			}
		}, {
			'key': 'onKeyDown',
			'value'(_4193979) {
    ...
    _ = new((() => {
		function _4514183() {
			_classCallCheck(this, _4514183), this.leftClick = c.get('mouse', 'leftClick') || 'off', this.middleClick = c.get('mouse', 'middleClick') || 'off', this.rightClick = c.get('mouse', 'rightClick') || 'off', this.x = 0, this.y = 0, this.canvas = document.getElementById('canvas'), this.canvasX = 0, this.canvasY = 0;
		}
		return _createClass(_4514183, [{
			'key': 'init',
			'value'() {
			...
			'value'(_4514183) {
				...
				0 > _4514183.wheelDelta ? _2530901 *= settings.zoomSpeed / 100 : _2530901 /= settings.zoomSpeed / 100, _2530901 = 2 < _2530901 ? 2 : 0.02 > _2530901 ? 0.02 : _2530901, L.targetViewport = _2530901;
			}
		}, {
			'key': 'onMouseClick',
			'value'(_4514183) {
				...
				if (_3893703) {
					if (L.isSpectating && 'on' === settings.targeting) {
						const _1398107 = (_4514183.clientX - (window.innerWidth >> 1)) / L.viewport + L.x,
							_370437 = (_4514183.clientY - (window.innerHeight >> 1)) / L.viewport + L.y;
			...
			'value'(_4514183, _3724175) {
				for (var _11512343, _2858313 = $(_4514183).attr('name'), s = $(_4514183).find('b'), _4265360 = s.length, _4784167 = _4265360, _2425684 = 0; _4784167--;) _11512343 = s[_4784167], 'active' === $(_11512343).attr('class') && (_2425684 = _4784167);
				if (1 === _3724175) {
					const _4514183 = _2425684 + 1 < _4265360 ? _2425684 + 1 : 0;
					$(s[_2425684]).removeAttr('class'), $(s[_4514183]).attr('class', 'active');
					const _3724175 = $(s[_4514183]).attr('value');
					...
					$(s[_2425684]).removeAttr('class');
					for (let _4514183, _3724175 = _4265360; _3724175--;)
						if (_4514183 = s[_3724175], $(_4514183).attr('value') === this[_2858313]) {
							$(_4514183).attr('class', 'active');
							break;
						}
				}
			}
			...
			'value'(_4514183, _4144055) {
				const _4205648 = $(_4514183).attr('name'),
					_2540822 = $(_4514183).find('span'),
					s = _2540822[0],
					_5508027 = _2540822[1],
					_4345995 = ~~$(s).attr('min'),
					_5104860 = ~~$(s).attr('max'),
					h = ~~$(s).attr('step'),
					c = ~~$(s).attr('value');
				if (1 === _4144055 && c + h <= _5104860) {
					const _4514183 = h + c;
					$(s).attr('value', _4514183), $(_5508027).css('width', ~~(100 * (_4514183 - _4345995) / (_5104860 - _4345995)) + 'px'), this.saveMouseOptions(_4205648, _4514183);
				} else if (0 === _4144055 && c - h >= _4345995) {
					const _4514183 = c - h;
					$(s).attr('value', _4514183), $(_5508027).css('width', ~~(100 * (_4514183 - _4345995) / (_5104860 - _4345995)) + 'px'), this.saveMouseOptions(_4205648, _4514183);
				} else if (2 === _4144055) {
					const _4514183 = this[_4205648];
					$(s).attr('value', _4514183), $(_5508027).css('width', ~~(100 * (_4514183 - _4345995) / (_5104860 - _4345995)) + 'px');
				}
			}
		}, {
			'key': 'saveMouseOptions',
			'value'(_4514183, _2239697) {
				this[_4514183] = _2239697, c.set('mouse', _4514183, _2239697);
			}
		}]), _4514183;
    })())(),
    ...
    l = atob('bmk='), u = (() => {
		function _1689046() {
			_classCallCheck(this, _1689046);
		}
		return _createClass(_1689046, null, [{
			'key': 'init',
			'value'() {
			...
			'key': 'load',
			'value'() {
				this.command1 = c.get('commands', 'command1') || p.current.commandsMenu.command1, this.command2 = c.get('commands', 'command2') || p.current.commandsMenu.command2, this.command3 = c.get('commands', 'command3') || p.current.commandsMenu.command3, this.command4 = c.get('commands', 'command4') || p.current.commandsMenu.command4, this.command5 = c.get('commands', 'command5') || p.current.commandsMenu.command5, this.command6 = c.get('commands', 'command6') || p.current.commandsMenu.command6, this.command7 = c.get('commands', 'command7') || p.current.commandsMenu.command7, this.command8 = c.get('commands', 'command8') || p.current.commandsMenu.command8, this.command9 = c.get('commands', 'command9') || p.current.commandsMenu.command9, this.command0 = c.get('commands', 'command0') || p.current.commandsMenu.command0, this.command11 = c.get('commands', 'command11') || p.current.commandsMenu.command11, this.command12 = c.get('commands', 'command12') || p.current.commandsMenu.command12, this.command13 = c.get('commands', 'command13') || p.current.commandsMenu.command13, this.command14 = c.get('commands', 'command14') || p.current.commandsMenu.command14;
			}
		}, {
			'key': 'addEvents',
			'value'() {
				...
				for (let _5293893 = 15, _3457172 = () => {
						...
						$('#' + _3457172).blur(() => {
							_1689046.setCommand(_3457172, $('#' + _3457172).val());
						});
					}; _5293893--;) _3457172();
			}
		}, {
			...
			'value'(_1689046, _16685317) {
				this[_1689046] = _16685317, c.set('commands', _1689046, _16685317);
			}
		}, {
			'key': 'setDomValues',
			'value'() {
				for (let _1689046, _1453076 = 15; _1453076--;) $('#' + (_1689046 = 'command' + _1453076)).val(this[_1689046]);
			}
		}, {
			'key': 'refresh',
			'value'() {
    ...
    d = (() => {
		function _5374672() {
			_classCallCheck(this, _5374672);
		}
		return _createClass(_5374672, null, [{
			'key': 'init',
			'value'() {
			...
			'key': 'toggleCellNick',
			'value'() {
				const _5374672 = c.get('settings', 'cellNick');
				settings.cellNick = 'off' === settings.cellNick ? 'off' !== _5374672 && _5374672 || 'on' : 'off';
			}
		}, {
			'key': 'toggleCellMass',
			'value'() {
				const _5374672 = c.get('settings', 'cellMass');
				const _5407025 = c.get('settings', 'hideOwnMass');
				settings.cellMass = 'off' === settings.cellMass ? 'off' !== _5374672 && _5374672 || 'shortened' : 'off';
				settings.hideOwnMass = 'off' === settings.hideOwnMass ? 'off' !== _5407025 && _5407025 || 'on' : 'off';
			}
		}, {
			'key': 'toggleGameFood',
			'value'() {
				const _5374672 = c.get('settings', 'food');
				settings.food = 'off' === settings.food ? 'off' !== _5374672 && _5374672 || 'monoColored' : 'off';
			}
		}, {
			'key': 'toggleBGsectors',
			'value'() {
				const _5374672 = c.get('settings', 'bgSectors');
				settings.bgSectors = 'off' === settings.bgSectors ? 'off' !== _5374672 && _5374672 || 'normal' : 'off';
			}
		}, {
			'key': 'toggleSkin',
			'value'() {
				const _5374672 = c.get('settings', 'urlSkins');
				settings.urlSkins = 'off' === settings.urlSkins ? 'off' !== _5374672 && _5374672 || 'on' : 'off';
			}
		}, {
			'key': 'toggleSplitRings',
			'value'() {
				const _5374672 = c.get('settings', 'splitRings');
				settings.splitRings = 'off' === settings.splitRings ? 'off' !== _5374672 && _5374672 || 'on' : 'off';
			}
		}, {
			'key': 'toggleOpponentRings',
			'value'() {
				const _5374672 = c.get('settings', 'opponentRings');
				settings.opponentRings = 'off' === settings.opponentRings ? 'off' !== _5374672 && _5374672 || 'on' : 'off';
			}
		}, {
			'key': 'togglemultiboxRing',
			'value'() {
				const _5374672 = c.get('settings', 'multiboxRing');
				settings.multiboxRing = 'off' === settings.multiboxRing ? 'off' !== _5374672 && _5374672 || 'on' : 'off';
			}
		}, {
			'key': 'togglemaouCircleSkin',
			'value'() {
				const _5374672 = c.get('settings', 'maouCircleSkin');
				settings.maouCircleSkin = 'off' === settings.maouCircleSkin ? 'off' !== _5374672 && _5374672 || 'on' : 'off';
			}
		}, {
			'key': 'respawn',
			'value'() {
    ...
    f = new((() => {
		function _5898259() {
			_classCallCheck(this, _5898259), this.masterUrl = 'https://webbouncer-live-v8-0.agario.miniclippt.com/v4', this.contentType = 'application/octet-stream', this.xSupportProtoVersion = '15.0.3';
		}
		return _createClass(_5898259, [{
			'key': 'getRegionsInfo',
			'value'() {
			...
			'value'(_5898259, _4604153) {
				if(_5898259.indexOf('ws')>-1){
					return {endpoints:{https:_5898259.match(/\/\/(.*)/)[1]}}
				}
			...
			'value'(_5898259, _5704764) {
				//if($('#regions').val().indexOf('Anta')>-1) return 'delta-server.glitch.me'
				...
				_1481993.open('POST', 'https://webbouncer-live-v8-0.agario.miniclippt.com/v4/getToken', false)
				this.setHeaders(_1481993)
				_1481993.send(_1824631)
				m.alert('HSLO', 'Joining game server ' + $('#party-token').val());
				console.log('HSLO: Joining game server ' + $('#party-token').val());
				try {
			...
			'value'(_5898259, _3730858) {
				...
				s.open('POST', this.masterUrl + '/createToken', false), this.setHeaders(s), s.send(_5410414), console.log('HSLO: Creating game server token.');
				try {
			...
			'value'(_5898259, _6239242) {
				...
				const s = new XMLHttpRequest();
				try {
					s.open('POST', this.masterUrl + '/getToken', false), this.setHeaders(s), s.send(_2860283);
				} catch (_4086507) {
				...
				try {
					const _6239242 = JSON.parse(s.responseText);
    ...
    g = new((() => {
		function _3325808() {
			_classCallCheck(this, _3325808);
		}
		return _createClass(_3325808, [{
			'key': 'init',
			'value'() {
			...
			'value'() {
				for (var _3325808 = {			
					...
					'wss://delta-selffeed.glitch.me': 'Zimbabve',
						...
						'wss://lm-server.glitch.me':'Test',
					}, _4785026 = f.getRegionsInfo().regions, _3703039 = Object.keys(_3325808), _2283036 = '', s = 0; s < _3703039.length; s++) {
					const _13701163 = _3703039[s];
					_2283036 += '<option value=\"' + _13701163 + '\">' + _3325808[_13701163] + (_4785026[_13701163]? ' (' + _4785026[_13701163].numPlayers + ')':''  )  +'</option>';
				}
				$('#regions').html(_2283036);
			}
		}, {
			'key': 'joinParty',
			'value'() {
				if (!this.connectWithIp()) {
					const _3325808 = $('#regions').val(),
			...
			'value'() {
				const _3325808 = $('#regions').val(),
					_1061349 = $('#gamemode').val(),
					_4943742 = f.getServer(_3325808, _1061349);
				if (_4943742.token) $('#party-token').val(_4943742.token);
				else {
					...
					_3325808 && _3325808[1] && $('#party-token').val(_12105870 + ':' + _3325808[1]);
				}
			...
			'key': 'getToken',
			'value'() {
				const _3325808 = $('#party-token').val().match(/\b[A-Z0-9]{6}\b/);
				if (_3325808 && _3325808[0]) {
					const _5212100 = _3325808[0];
					return $('#party-token').val(_5212100), _5212100;
				}
				return false;
			}
		}, {
			'key': 'connectWithIp',
			'value'() {
				const _3325808 = $('#party-token').val(),
					_2735906 = _3325808.match(/live-arena-[0-9a-z]{5,8}\.agar.\io\:\d{1,5}/);
				if (_2735906 && _2735906[0]) return q.init(_2735906[0]), $('#party-token').val(_2735906[0]), true;
    ...
    y = new((() => {
		function _1686623() {
			_classCallCheck(this, _1686623), this.siteKey = '6LfjUBcUAAAAAF6y2yIZHgHIOO5Y3cU5osS2gbMl', this.inited = false, this.container = $('#captchaWindow');
		}
		return _createClass(_1686623, [{
			'key': 'asyncInit',
			'value'() {
				this.onloadCallback();
			}
    ...
    oe = (() => {
		function _4989757() {
			_classCallCheck(this, _4989757);
		}
		return _createClass(_4989757, null, [{
			'key': 'init',
			'value'() {
				this.isOpened = false
				this.div = $('#theme')
				...
				this.fantasyColor = c.get('theme', 'fantasyColor') || '#fff'
				this.fantasyAlpha = c.get('theme', 'fantasyAlpha') || 0
				this.addPresets()
				this.setDomValues()
				this.addEvents();
			}
			...
			'value'() {
				...
				$('.theme-container').perfectScrollbar(), $('.theme-container .fa-chevron-left').each(function () {
					const _2599111 = this;
					$(this).click(() => {
						const _14889705 = $(_2599111).parent(),
							_5940826 = $(_14889705).attr('type');
			...
			'value'(_4989757, _5208379) {
				for (var _5981244, _4065388 = $(_4989757).attr('name'), s = $(_4989757).find('b'), _3038208 = s.length, _3198382 = _3038208, _3248500 = 0; _3198382--;) _5981244 = s[_3198382], 'active' === $(_5981244).attr('class') && (_3248500 = _3198382);
				if (1 === _5208379) {
					const _4989757 = _3248500 + 1 < _3038208 ? _3248500 + 1 : 0;
					$(s[_3248500]).removeAttr('class'), $(s[_4989757]).attr('class', 'active');
					const _5208379 = $(s[_4989757]).attr('value');
					...
					$(s[_3248500]).removeAttr('class');
					for (let _4989757, _5208379 = _3038208; _5208379--;)
						if (_4989757 = s[_5208379], $(_4989757).attr('value') === this[_4065388]) {
							$(_4989757).attr('class', 'active');
							break;
						}
				}
			}
			...
			'value'(_4989757, _4156470) {
				const _5588769 = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
					_9532630 = $(_4989757).attr('name'),
					s = $(_4989757).find('span'),
					_5428997 = s[0],
					_1466059 = s[1],
					_8780081 = $(s[2]),
					h = ~~$(_5428997).attr('min'),
					c = ~~$(_5428997).attr('max'),
					_3892851 = ~~$(_5428997).attr('step'),
					_8237475 = ~~$(_5428997).attr('value');
				if (1 === _4156470 && _8237475 + _3892851 <= c) {
					const _4989757 = _3892851 + _8237475;
					$(_5428997).attr('value', _4989757), $(_1466059).css('width', ~~(100 * (_4989757 - h) / (c - h)) + 'px'), _8780081.text(_4989757), this.saveTheme(_9532630, ~~_4989757);
				} else if (0 === _4156470 && _8237475 - _3892851 >= h) {
					const _4989757 = _8237475 - _3892851;
					$(_5428997).attr('value', _4989757), $(_1466059).css('width', ~~(100 * (_4989757 - h) / (c - h)) + 'px'), _8780081.text(_4989757), this.saveTheme(_9532630, ~~_4989757);
				} else if (2 === _4156470) {
					const _4989757 = this[_9532630];
					$(_5428997).attr('value', _4989757), $(_1466059).css('width', ~~(100 * (_4989757 - h) / (c - h)) + 'px'), _8780081.text(_4989757);
				} else if (3 === _4156470) {
					let _4989757 = 0 | _5588769 / 100 * (c - h);
					_4989757 = (0 | _4989757 / _3892851) * _3892851;
					const _4156470 = 100 * ((_4989757 += h) - h) / (c - h);
					$(_5428997).attr('value', _4989757), $(_1466059).css('width', ~~_4156470 + 'px'), _8780081.text(_4989757), this.saveTheme(_9532630, ~~_4989757);
				}
			}
		}, {
			'key': 'initColorpicker',
			...
			'value'(_4989757, _4719291) {
				this[_4989757] = _4719291, 'selectedPreset' === _4989757 ? this.selectPreset(_4719291) : 'custom' !== this.selectedPreset && (this.selectedPreset = 'custom', c.set('theme', 'selectedPreset', 'custom'), this.setDomValues()), 'backgroundColor' === _4989757 && this.setBackground(_4719291), 'chatFontSize' === _4989757 && this.setChatFontSize(_4719291), 'chatroomSize' === _4989757 && this.setChatroomSize(_4719291), 'lbSize' === _4989757 && this.setLeaderboard(_4719291), 'minimapSize' === _4989757 && this.setMinimap(_4719291), 'cursor' === _4989757 && this.setCursor(_4719291), 'massFont' === _4989757 && P.setMassCtxFont(), 'nickFont' === _4989757 && P.setNickCtxFont(), 'massStrokeColor' === _4989757 && P.massCaches.clear(), 'nickStrokeColor' === _4989757 && P.nickCaches.clear(), 'massColor' === _4989757 && P.massCaches.clear(), 'nickColor' === _4989757 && P.nickCaches.clear(), ('foodColor' === _4989757 || 'foodSize' === _4989757 || 'foodGlow' === _4989757 || 'foodGlowSize' === _4989757 || 'foodGlowStrength' === _4989757) && H.init(), ('borderColor' === _4989757 || 'borderWidth' === _4989757 || 'borderGlow' === _4989757 || 'borderGlowSize' === _4989757 || 'borderGlowStrength' === _4989757) && be.init(), ('virusColor' === _4989757 || 'virusBorderWidth' === _4989757 || 'virusBorderColor' === _4989757 || 'virusGlow' === _4989757 || 'virusGlowSize' === _4989757 || 'virusGlowStrength' === _4989757) && de.init(), c.set('theme', _4989757, _4719291);
			}
		}, {
			'key': 'setBackground',
			'value'(_4989757) {
				$('body').css('background', _4989757);
			}
		}, {
			'key': 'setChatFontSize',
			'value'(_4989757) {
				$('#notifications').css('font-size', _4989757 + 'px'), $('span.chattime').css('font-size', ~~(_4989757 * 12 / 14) + 'px'), $('span.nick').css('font-size', _4989757 + 'px'), $('span.message').css('font-size', _4989757 + 'px'), m.chatroomdiv.scrollTop(m.chatroomdiv[0].scrollHeight);
			}
		}, {
			'key': 'setChatroomSize',
			'value'(_4989757) {
				$('#chatroom').css('width', ~~(_4989757 / 100 * 500) + 'px'), $('#chatroom').css('height', ~~(_4989757 / 100 * 560) + 'px'), m.chatroomdiv.scrollTop(m.chatroomdiv[0].scrollHeight);
			}
		}, {
			'key': 'setLeaderboard',
			'value'(_4989757) {
				const _2115255 = _4989757 / 100;
				$('#leaderboard-head').css('font-size', (0 | 24 * _2115255) + 'px'), $('#leaderboard-positions').css('font-size', (0 | 13 * _2115255) + 'px');
			}
		}, {
			'key': 'setMinimap',
			'value'(_4989757) {
				S.size = _4989757, S.canvas.width = _4989757, S.canvas.height = _4989757, $('#minimap-hud, .minimap-grid').css({
					'width': _4989757 + 'px',
					'height': _4989757 + 'px'
				}), $('.minimap-row').css({
					'width': _4989757 + 'px',
				...
				}), $('.minimap-head').css('bottom', _4989757 + 9 + 'px'), $('#time-hud').css('font-size', ~~(_4989757 / 15) + 'px');
			}
		}, {
			'key': 'setCursor',
			'value': _4989757 => 1 === _4989757 ? ($('body').css('cursor', 'url(),auto'), $('#cursorOff').show(), void $('#cursorDisplay').hide()) : ($('body').css('cursor', 'url(https://jimboy3100.github.io/cursors/cursor_' + (9 < _4989757 ? _4989757 : '0' + _4989757) + '.cur),auto'), $('#cursorDisplay').attr('src', 'https://jimboy3100.github.io/cursors/cursor_' + (9 < _4989757 ? _4989757 : '0' + _4989757) + '.cur'), $('#cursorDisplay').show(), void $('#cursorOff').hide())
		}, {
			'key': 'selectPreset',
			'value'(_4989757) {
				const _15510291 = this.presets[_4989757];
				if ('custom' !== _4989757 && _15510291) {
					for (const _4989757 in _15510291.theme) _15510291.theme.hasOwnProperty(_4989757) && void 0 !== this[_4989757] && (this[_4989757] = _15510291.theme[_4989757], c.set('theme', _4989757, this[_4989757]));
					for (const _4989757 in this.setDomValues(), _15510291.settings) _15510291.settings.hasOwnProperty(_4989757) && void 0 !== settings[_4989757] && (settings[_4989757] = _15510291.settings[_4989757], c.set('settings', _4989757, settings[_4989757]));
    ...
    window.classoe = oe, m = (() => {
		function _13897069() {
			_classCallCheck(this, _13897069);
		}
		return _createClass(_13897069, null, [{
			'key': 'init',
			'value'() {
				this.div = $('#notifications'), this.duration = 10000, this.animDuration = 500, this.iconChat = '<i class=\"fa fa-comment\"></i>', this.iconAlert = '<i class=\"fa fa-exclamation-circle\"></i>', this.iconBell = '<i class=\"fa fa-bell\"></i>', this.chatroomdiv = $('#chatroom'), this.emojiPath = 'https://hslo.yueagar.ml/emojis/', this.emojis = {
					':01:': 'angry.png',
					':02:': 'angry-1.png',
					':03:': 'cool.png',
					':04:': 'crying.png',
			...
			'key': 'displayEmojis',
			'value'() {
				const _13897069 = $('#emojiContainer'),
					_3312436 = _3312436 => {
						const _1896399 = $('<img src=\"https://hslo.yueagar.ml/emojis/' + this.emojis[_3312436] + '\" class=\"emojiPreview\">');
						_1896399.click(() => {
							const _13897069 = $('#message'),
			...
			'value'(_13897069, _6111178) {
				if ('on' === settings.sounds && _5297403.playChat(), this.chatroom(_13897069, _6111178, this.iconChat), 'chatroom' !== settings.chatType) {
			...
			'value'(_13897069, _2850878) {
				if ('on' === settings.sounds && _5297403.playCmd(), this.chatroom(_13897069, _2850878, this.iconAlert), 'chatroom' !== settings.chatType) {
			...
			'value'(_13897069, _5059459) {
				if ('on' === settings.sounds && _5297403.playAlert(), this.chatroom(_13897069, _5059459, this.iconBell), 'chatroom' !== settings.chatType) {
			...
			'value'(_13897069, _4300757, _3079240) {
				const _5417660 = new Date(),
					s = (9 < _5417660.getHours() ? _5417660.getHours() : '0' + _5417660.getHours()) + ':' + (9 < _5417660.getMinutes() ? _5417660.getMinutes() : '0' + _5417660.getMinutes());
				this.chatroomdiv.append('<div class=\"chatroom-row\"><span class=\"chattime\">' + s + '</span> ' + _3079240 + ' <span class=\"nick\">' + _13897069 + '</span> <span class=\"message\">' + this.putEmojis(this.cleanMessages(_4300757)) + '</span></div>'), oe.setChatFontSize(oe.chatFontSize), this.chatroomdiv.scrollTop(this.chatroomdiv[0].scrollHeight);
			}
		}]), _13897069;
    })(),
	...
	const _5297403 = (() => {
			function _16495873() {
				_classCallCheck(this, _16495873);
			}
			return _createClass(_16495873, null, [{
				'key': 'init',
				'value'() {
		...
		_5451753 = new((() => {
			function _2325961() {
				_classCallCheck(this, _2325961), this.loggedIn = false, this.token = '', this.button = $('#login-facebook'), this.options = {
			...
			return _createClass(_2325961, [{
				...
				'value'() {
					...
					$('#login-facebook').click(() => {
						...
						_2325961.logout();
					}), window.FB ? FB.init(this.options) : m.alert('Facebook', p.current.notif.sdk_error);
				}
			}, {
				'key': 'init',
				'value'() {
					const _2325961 = c.get('extras', 'fbToken');
					if (_2325961) {
						const _6219628 = Date.now();
						return _2325961.expiry < _6219628 ? void c.set('extras', 'fbToken', '') : (this.token = _2325961.token, this.loggedIn = true, this.button.addClass('active'), void m.alert('Facebook', p.current.notif.login_lastSession), Q.freeCoins(1));
					}
				}
			}, {
				'key': 'login',
				'value'() {
					const _2325961 = this;
					return this.loggedIn ? void m.alert('Facebook', p.current.notif.logged) : void(window.FB ? window.FB.login(_4701020 => {
				...
				'key': 'afterLogin',
				'value'(_2325961) {
					_2325961.authResponse ? (this.token = _2325961.authResponse.accessToken, c.set('extras', 'fbToken', {
						'token': this.token,
						'expiry': Date.now() + 1000 * _2325961.authResponse.expiresIn
					}), this.loggedIn = true, this.button.addClass('active'), Q.fbToken(), m.alert('Facebook', p.current.notif.login_success), Q.freeCoins(1)) : m.alert('Facebook', p.current.notif.login_error);
				}
			}, {
				'key': 'logout',
				'value'() {
					const _2325961 = this;
					this.loggedIn && window.FB.logout(_2116458 => {
						_2116458.authResponse && (_2325961.loggedIn = false, _2325961.token = null, Q.triedCoins = false, _2325961.button.removeClass('active'), m.alert('Facebook', p.current.notif.logout), c.set('extras', 'fbToken', ''));
					});
				}
			}]), _2325961;
        })())(),
		...
		_4188507 = (() => {
			function _2033245() {
				_classCallCheck(this, _2033245);
			}
			return _createClass(_2033245, null, [{
				'key': 'init',
				'value'() {
					const _2033245 = this;
					this.loggedIn = false, this.token = null;
					const _2999773 = c.get('extras', 'googleToken');
					_2999773 && (_2999773.expiry > Date.now() ? (this.token = _2999773.token, this.loggedIn = true, $('#login-google').addClass('active'), Q.googleToken(), m.alert('Google+', p.current.notif.login_lastSession), Q.freeCoins(2)) : c.set('extras', 'googleToken', false)), window.gapi ? window.gapi.load('auth2', () => {
						const _2999773 = gapi.auth2.init({
								'client_id': '686981379285-oroivr8u2ag1dtm3ntcs6vi05i3cpv0j.apps.googleusercontent.com',
								'cookiepolicy': 'single_host_origin'
							}),
							_4345436 = document.getElementById('login-google');
						_2999773.attachClickHandler(_4345436, {}, _2999773 => {
							_2033245.afterLogin(_2999773);
						}, _2033245 => {
							console.log(_2033245);
						});
					}) : m.alert('Google+', p.current.notif.sdk_error), $('#logout').click(() => {
						_2033245.logout();
					});
				}
			}, {
				...
				'value'(_2033245) {
					...
					_10087540 ? (this.token = _10087540, c.set('extras', 'googleToken', {
						'token': this.token,
						'expiry': _5959619.expires_at
					}), this.loggedIn = true, $('#login-google').addClass('active'), Q.googleToken(), m.alert('Google+', p.current.notif.login_success), Q.freeCoins(2)) : m.alert('Google+', p.current.notif.login_error);
				}
			}, {
				'key': 'logout',
				'value'() {
					if (this.loggedIn) {
						gapi.auth2.getAuthInstance().signOut(), this.loggedIn = false, Q.triedCoins2 = false, this.token = null, $('#login-google').removeClass('active'), m.alert('Google+', p.current.notif.logout), c.set('extras', 'googleToken', false);
					}
				}
			}]), _2033245;
		})(),
		LEADERBOARD = (() => {
			function _4249194() {
				_classCallCheck(this, _4249194);
			}
			return _createClass(_4249194, null, [{
				'key': 'init',
				'value'() {
				...
				'key': 'add',
				'value'(_4249194, _4496799, _4032791, _1723722, s) {
					this.list.add({
						'nick': _4249194,
						'position': _4496799,
						'isSelf': _4032791,
					...
					for (const _1194873 of this.list.values()) {
						...
						try {
							if(ghostCells[0].mass==1000){
							  _5132708.nick.innerHTML = this.cleanNick(_1194873.nick);
							}else{
				...
				'value'(_5916335) {
					const _4249194 = [],
						_3255325 = [],
						_2482321 = $('.lb-position'),
						_5614245 = $('.lb-data');
					for (const _4767513 of _2482321) {
						const _2482321 = $(_4767513).children(),
							_2565903 = _2482321[0],
							s = _2482321[1];
						_4249194.push({
							'element': _4767513,
					...
					for (const _13851981 of _5614245) {
						const _2482321 = $(_13851981).children(),
							_1490897 = _2482321[0],
							s = _2482321[1];
						_3255325.push({
							'element': _13851981,
	...
	window.te = LEADERBOARD;
	S = new((() => {
		function _5998834() {
			_classCallCheck(this, _5998834), this.canvas = $('#minimap-nodes')[0], this.ctx = this.canvas.getContext('2d'), this.size = 200, this.canvas.width = this.size, this.canvas.height = this.size, this.pi2 = 2 * Math.PI, this.ratio = 1, this.ctx.textAlign = 'center', this.ctx.textBaseline = 'bottom', this.ctx.lineWidth = 2;
		}
		return _createClass(_5998834, [{
			'key': 'run',
			'value'() {
			...
			'value'() {
				const _5998834 = L.viewBounds,
					...
					s = 0 | (_5998834.bottom - _5998834.top) * this.ratio;
				this.ctx.globalAlpha = oe.selfViewportAlpha / 10, this.ctx.fillStyle = oe.selfViewportColor, this.ctx.fillRect(_4759602, _9298316, _2327168, s);
			}
		}, {
			...
			'value'() {
				const _5998834 = I.bound3,
					...
					s = 0 | (_5998834.bottom - _5998834.top) * this.ratio;
				this.ctx.globalAlpha = oe.topViewportAlpha / 10, this.ctx.fillStyle = oe.topViewportColor, this.ctx.fillRect(_13268583, _14583207, _4985596, s);
			}
		}, {
			...
			'value'() {
				...
				for (let _5998834 = 0; _5998834 < ghostCells.length; _5998834++) {
					const _5482286 = 0 | (7071 - G.offset3.x + ghostCells[_5998834].x) * this.ratio,
						...
						s = ghostCells[_5998834]
['size'] * this.ratio;
					this.ctx.moveTo(_5482286 + s, _4135819);
					this.ctx.arc(_5482286, _4135819, s, 0, this.pi2, false);
				};
    ...
    v = () => {}, C = new((() => {
		function _4285467() {
			_classCallCheck(this, _4285467), this.lastUpdateTime = 0, this.totalmass = 0, this.alive = 0, this.spectate = 0, this.html = '', this.temporayArray = [], this.div = {
    ...
    w = (() => {
		function _3974962() {
			_classCallCheck(this, _3974962);
		}
		return _createClass(_3974962, null, [{
			'key': 'init',
			'value'() {
				const _3974962 = this;
				this.container = $('#message-hud'), this.input = $('#message'), this.isOpened = false, this.isFocused = false, this.input.blur(() => {
    ...
    T = new((() => {
		function _4088757() {
			_classCallCheck(this, _4088757), this.fpsCount = 0, this.lastUpdateTime = 0, this.div = $('#stats-hud')[0], this.timeHud = $('#time-hud')[0], this.icon = {
    ...
    F = () => {
		...
		function _4499860() {
			_classCallCheck(this, _4499860);
		}
		return _createClass(_4499860, null, [{
			'key': 'init',
			'value'() {
    ...
    z = (() => {
		function _4325503() {
			_classCallCheck(this, _4325503);
		}
		return _createClass(_4325503, null, [{
			'key': 'init',
			'value'() {
				_5297403.init(), m.init(), settings.init(), _5326466.init(), _5736151.init(), g.init(), oe.init(), _5451753.init(), _4188507.init(), LEADERBOARD.init(), w.init(), K.init(), P.setMassUpdateInterval(), this.isOpened = true, this.gMode = ':party', this.div = $('#menu-overlay'), this.streammode = !c.get('extras', 'streammode') && [], this.toggleStreammode(), this.buttons(), this.versionCheck();
			}
		}, {
			'key': 'buttons',
			'value'() {
				...
				$('#button-settings').click(() => {
					_4325503.closeSubMenus(), settings.toggle();
				}), $('#button-play').click(() => {
					_4325503.play();
					...
					c.set('extras', 'region', $('#regions').val());
				}), $('#regions').val(c.get('extras', 'region') || 'JP-Tokyo'), $('#gamemode').change(() => {
					c.set('extras', 'gameMode', $('#gamemode').val()), _4325503.gMode = c.get('extras', 'gameMode');
				}), $('#gamemode').val(c.get('extras', 'gameMode') || ':party'), this.gMode = c.get('extras', 'gameMode') || ':party', $('#minimap-show-1').click(() => {
					$('#minimap-show-' + S.selector).removeClass('active'), $('#minimap-show-1').addClass('active'), S.selector = 1;
				}), $('#minimap-show-2').click(() => {
					$('#minimap-show-' + S.selector).removeClass('active'), $('#minimap-show-2').addClass('active'), S.selector = 2;
				}), $('#minimap-show-0').click(() => {
					$('#minimap-show-' + S.selector).removeClass('active'), $('#minimap-show-0').addClass('active'), S.selector = 0;
				}), $('#streamMode').click(() => {
				...
				}), c.get('extras', 'openedChangelog') || $('#changelog').addClass('active'), $('#changelog').click(() => {
					c.set('extras', 'openedChangelog', true), $('#changelog').removeClass('active');
				});
			}
		}, {
			'key': 'play',
			...
			'key': 'closeSubMenus',
			'value'() {
				_5326466.close(), settings.close(), oe.close();
			}
		}, {
			'key': 'toggle',
			'value'() {
			...
			'key': 'close',
			'value'() {
				this.isOpened = false, this.div.fadeOut(250), $('#leaderboard-hud').css('top', '-2px'), $('#teamlist-hud').css('top', '10px'), $('.menu-bar').slideUp(250), $('#targeting-hud').css('top', '0px');
			}
		}, {
			'key': 'open',
			'value'() {
				this.isOpened = true, this.div.fadeIn(250), $('#leaderboard-hud').css('top', '30px'), $('#teamlist-hud').css('top', '45px'), $('.menu-bar').slideDown(250), $('#targeting-hud').css('top', '35px');
			}
		}, {
			'key': 'toggleStreammode',
			'value'() {
				this.streammode ? ($('#nick, #nick2, #tag, #skin, #skin2, #party-token').removeClass('input-hidden'), $('#streamMode').html('<i class=\"fas fa-eye\"></i>'), this.streammode = false, c.set('extras', 'streammode', this.streammode)) : ($('#nick, #nick2, #tag, #skin, #skin2, #party-token').addClass('input-hidden'), $('#streamMode').html('<i class=\"fas fa-eye-slash\"></i>'), this.streammode = true, c.set('extras', 'streammode', this.streammode));
			}
		}, {
			'key': 'spectateModeTop',
			'value'() {
			...
			'key': 'versionCheck',
			'value'() {
				'5.3.2 (17)' !== localStorage.getItem('version') ? (console.log('Your extension is in older version.'), this.showChangelog(), localStorage.setItem('version', '5.3.2 (17)'), c.set('extras', 'version', '5.3.2 (17)')) : console.log('Great! Your extension is updated!.');
			}
		}, {
			'key': 'showChangelog',
			'value'() {
				$('#anouncement').html(window['lang_' + p.selected].updateHud.title + '<br>' + window['lang_' + p.selected].updateHud.desc + (!localStorage.getItem('version').includes('5.3.2') ? '<br>' + window['lang_' + p.selected].updateHud.versionChange : '') + '<hr>' + window['lang_' + p.selected].updateHud.updateContent + '<br><hr><div align=\"right\">2019-11-26</div>'), $('#anouncement').fadeIn(250);
			}
		}]), _4325503;
    })(),
    ...
    I = new((() => {
		function _5246992() {
			_classCallCheck(this, _5246992);
		}
		return _createClass(_5246992, [{
			'key': 'init',
			'value'() {
			...
			'key': 'update',
			'value'() {
				var oponentRingsEnabled = "on" === settings.opponentRings && A.isAlive;
				var appt = "on" === settings.virusRange && A.isAlive;
				//stats1.update();
				this.updateBound();
				this.food = [];
				this.sortedCells = [];
				ve.reset();
				ie.reset();
				this.cellsTab1.forEach((data, marketID) => {
					this.updateStaticBound(data, 1);
					if (data.fadeStartTime) {
						if (1 < (le.time - data.fadeStartTime) / settings.CellAnimation) {
							return void this.cellsTab1.delete(marketID);
						}
					}
					window.teste1 = data;
					if (this.isInView(data) && data.worldID !== A.worldID2) {
						if (data.isFood) {
							this.food.push(data);
						} else {
							data.animate();
							this.sortedCells.push(data);
							if (oponentRingsEnabled && !data.isVirus) {
								ie.segregator(data, 1);
							}
							if (appt && data.isVirus) {
								ve.add(data, 1);
							}
						}
					}
				});
				this.cellsTab2.forEach((data, marketID) => {
					this.updateStaticBound(data, 2);
					if (data.fadeStartTime) {
						if (1 < (le.time - data.fadeStartTime) / settings.CellAnimation) {
							return void this.cellsTab2.delete(marketID);
						}
					}
					window.teste2 = data;
					if (this.isInView(data) && (data.isMine || !this.isInView2(data))) {
						if (data.isFood) {
							this.food.push(data);
						} else {
							data.animate();
				...
				this.cellsTab3.forEach((data, marketID) => {
					this.updateStaticBound(data, 3);
					if (data.fadeStartTime) {
						if (1 < (le.time - data.fadeStartTime) / settings.CellAnimation) {
							return void this.cellsTab3.delete(marketID);
						}
					}
					window.teste3 = data;
					if (this.isInView(data) && (data.isMine || !this.isInView3(data, 1) && !this.isInView3(data, 2)) && data.worldID !== A.worldID2 && settings.topZoom === "on") {
						if (data.isFood) {
							this.food.push(data);
						} else {
							data.animate();
				...
				this.sortedCells.sort((b, a) => {
					var last_len = b.animRadius;
					var from_last = a.animRadius;
			...
			'value'(_5246992, _2881674, _3742047) {
				const _4837381 = 1 === _3742047 ? this.cellsIDTab1 : 2 === _3742047 ? this.cellsIDTab2 : 3 === _3742047 && this.cellsIDTab3,
					s = 1 === _3742047 ? this.myCellsTab1 : 2 === _3742047 ? this.myCellsTab2 : 3 === _3742047 && this.myCellsTab3;
				_4837381.has(_5246992) && (s.set(_5246992, _2881674), _4837381.delete(_5246992), _2881674.isMine = true, _2881674.nick = 1 === _3742047 ? A.nick : 2 === _3742047 ? A.nick2 : '');
			}
		}, {
			'key': 'eatCell',
			'value'(_5246992, _1747417, _7526961) {
				const _3014390 = 1 === _7526961 ? this.cellsTab1 : 2 === _7526961 ? this.cellsTab2 : 3 === _7526961 && this.cellsTab3,
					s = 1 === _7526961 ? this.myCellsTab1 : 2 === _7526961 ? this.myCellsTab2 : 3 === _7526961 && this.myCellsTab3,
					_3021170 = _3014390.get(_1747417),
					_4123434 = _3014390.get(_5246992);
				_3021170 && _4123434 && (_3021170.staticX = _4123434.staticX, _3021170.staticY = _4123434.staticY, _3021170.radius = _3021170.animRadius, _3021170.lastUpdateTime = le.time, _3021170.fadeStartTime = le.time, _3021170.isMine && s.delete(_1747417), _3014390.delete(_1747417), _3021170.isFood || _3014390.set(_1747417 + ':removed', _3021170));
			}
		}, {
			'key': 'removeCell',
			'value'(_5246992, _5904439) {
				const _6245666 = 1 === _5904439 ? this.cellsTab1 : 2 === _5904439 ? this.cellsTab2 : 3 === _5904439 && this.cellsTab3,
					...
					s = _6245666.get(_5246992);
				s && (s.isMine && _5546164.delete(_5246992), _6245666.delete(_5246992), s.isFood || 'on' !== settings.eatAnimation || (s.fadeStartTime = le.time, _6245666.set(_5246992 + ':removed', s)));
			}
		}, {
			'key': 'isInView',
			'value'(_5246992) {
			...
			'value'() {
				...
				I.cellsTab1.forEach(_5246992 => {
					this.bound.left = _5246992.staticX
					this.bound.right = _5246992.staticX
					this.bound.top = _5246992.staticY
					this.bound.bottom = _5246992.staticY;
					//console.log(this.bound)
				}), I.cellsTab2.forEach(_5246992 => {
					this.bound2.left = _5246992.staticX - G.getOffset2.x
					this.bound2.right = _5246992.staticX - G.getOffset2.x
					this.bound2.top = _5246992.staticY - G.getOffset2.y
					this.bound2.bottom = _5246992.staticY - G.getOffset2.y;
				}), I.cellsTab3.forEach(_5246992 => {
					this.bound3.left = _5246992.staticX - G.getOffset3.x
					this.bound3.right = _5246992.staticX - G.getOffset3.x
					this.bound3.top = _5246992.staticY - G.getOffset3.y
					this.bound3.bottom = _5246992.staticY - G.getOffset3.y;
				});
			}
		}, {
			'key': 'updateStaticBound',
			'value'(_5246992, _4383652) {
				const c = _4383652 === 2 ? G.getOffset2 : _4383652 === 3 ? G.getOffset3 : {
					'x': 0,
					'y': 0
				};
				if (_4383652 === 1) {
					this.bound.left > _5246992.staticX - c.x + _5246992.radius && (this.bound.left = _5246992.staticX - c.x + _5246992.radius)
					this.bound.right < _5246992.staticX - c.x - _5246992.radius && (this.bound.right = _5246992.staticX - c.x - _5246992.radius)
					this.bound.top > _5246992.staticY - c.y + _5246992.radius && (this.bound.top = _5246992.staticY - c.y + _5246992.radius)
					this.bound.bottom < _5246992.staticY - c.y - _5246992.radius && (this.bound.bottom = _5246992.staticY - c.y - _5246992.radius);
				} else if (_4383652 === 2) {
					this.bound2.left > _5246992.staticX - c.x + _5246992.radius && (this.bound2.left = _5246992.staticX - c.x + _5246992.radius)
					this.bound2.right < _5246992.staticX - c.x - _5246992.radius && (this.bound2.right = _5246992.staticX - c.x - _5246992.radius)
					this.bound2.top > _5246992.staticY - c.y + _5246992.radius && (this.bound2.top = _5246992.staticY - c.y + _5246992.radius)
					this.bound2.bottom < _5246992.staticY - c.y - _5246992.radius && (this.bound2.bottom = _5246992.staticY - c.y - _5246992.radius);
				} else if (_4383652 === 3) {
					this.bound3.left > _5246992.staticX - c.x + _5246992.radius && (this.bound3.left = _5246992.staticX - c.x + _5246992.radius)
					this.bound3.right < _5246992.staticX - c.x - _5246992.radius && (this.bound3.right = _5246992.staticX - c.x - _5246992.radius)
					this.bound3.top > _5246992.staticY - c.y + _5246992.radius && (this.bound3.top = _5246992.staticY - c.y + _5246992.radius)
					this.bound3.bottom < _5246992.staticY - c.y - _5246992.radius && (this.bound3.bottom = _5246992.staticY - c.y - _5246992.radius);
				}
			}
		}, {
			'key': 'isInView2',
			'value'(_5246992) {
				const _1201755 = G.getOffset2,
					...
					s = this.bound;
				return !(_5806257 + _5246992.radius < s.left || _5806257 - _5246992.radius > s.right || _1801904 + _5246992.radius < s.top || _1801904 - _5246992.radius > s.bottom);
			}
		}, {
			'key': 'isInView3',
			'value'(_5246992, _5622803) {
				const _4780201 = G.getOffset3,
					...
					s = _5622803 === 1 ? this.bound : _5622803 === 2 && this.bound2;
				return !(_2573689 + _5246992.radius < s.left || _2573689 - _5246992.radius > s.right || _923678 + _5246992.radius < s.top || _923678 - _5246992.radius > s.bottom);
			}
		}]), _5246992;
    })())(),
    ...
    window.classI = I, M = (() => {
		function _13733995(_11732835, _2315953) {
			_classCallCheck(this, _13733995)
			this.id = _11732835
			this.nick = ''
			this.skin = ''
		...
		return _createClass(_13733995, [{
			'key': 'animate',
			'value'() {
				let _8204076 = (le.time - this.lastUpdateTime) / settings.CellAnimation;
    ...
    A = (() => {
		function _4127260() {
			_classCallCheck(this, _4127260);
		}
		return _createClass(_4127260, null, [{
			'key': 'init',
			'value'() {
				this._nick = $('#nick').val()
				this._nick2 = $('#nick2').val()
				this._skin = re.getImgurCode($('#skin').val())
				this._skin2 = re.getImgurCode($('#skin2').val())
				this._tag = $('#tag').val()
				this._colorObject = {
					'r': 0,
					'g': 0,
				...
				this.isAliveTab1 = false
				this.isAliveTab2 = false
				this.x = 0
				this.y = 0
				this.x1 = 0
				this.x2 = 0
			...
			'value'() {
				if (this.isAlive) {
					...
					if (this.mass2 = 0, this.isAliveTab2) {
						...
						for (const s of I.myCellsTab2.values()) s.animate(), _4738368 += (s.x - _1249945.x) / this.pieceCount2, _5513006 += (s.y - _1249945.y) / this.pieceCount2, _14235728 += s.animRadius, this.mass2 += s.staticMass, this.mass += s.staticMass, this.biggestPieceMass < s.staticMass && (this.biggestPieceMass = s.staticMass);
					}
					if (!this.movementPaused) {
						const _14235728 = this.x - _4127260,
							_3278751 = this.y - _5783189,
							s = Math.sqrt(_14235728 * _14235728 + _3278751 * _3278751);
						this.speed += s, this.x = this.isAliveTab1 && this.isAliveTab2 ? (_4127260 + _4738368) / 2 : this.isAliveTab1 ? _4127260 : this.isAliveTab2 && _4738368, this.x1 = _4127260, this.x2 = _4738368, this.y = this.isAliveTab1 && this.isAliveTab2 ? (_5783189 + _5513006) / 2 : this.isAliveTab1 ? _5783189 : this.isAliveTab2 && _5513006, this.y1 = _5783189, this.y2 = _5513006;
					}
					this.score < this.mass && (this.score = this.mass);
					const _1609444 = Math.pow(Math.min(64 / _14235728, 1), 0.4),
						_4580147 = Math.max(window.innerWidth / 1920, window.innerHeight / 1080);
			...
			'set'(_4127260) {
				...
				return _6173389 ? (this._skin = _6173389, void _e.skin()) : void m.alert('HSLO', p.current.notif.invalidSkinUrl);
			},
			'get'() {
				return this._skin;
			}
			...
			'set'(_4127260) {
				...
				return _5363525 ? (this._skin2 = _5363525, void _e.skin2()) : void m.alert('HSLO', p.current.notif.invalidSkinUrl);
			},
			'get'() {
				return this._skin2;
			}
    ...
    window.classA = A, O = (() => {
		function _3603880(_4930142) {
			_classCallCheck(this, _3603880), this.id = _4930142, this.isNew = 2, this.x = 90, this.y = 90, this.isAlive = 0, this.mass = 0, this.nick = '', this.skin = '', this.colorHex = '#000', this.isRGB = false, this.animX = 90, this.animY = 90, this.timeStamp = le.time, this.lastUpdateAt = le.time, this.team = 1;
		}
		return _createClass(_3603880, [{
			'key': 'animate',
			'value'() {
    ...
    R = new((() => {
		function _2920938() {
			_classCallCheck(this, _2920938), this.indicator = this.cacheIndicator();
		}
		return _createClass(_2920938, [{
			'key': 'cacheIndicator',
			'value'() {
				const _2920938 = document.createElement('canvas'),
					_5349459 = _2920938.getContext('2d'),
					_3188647 = new Image();
				return _2920938.width = 150, _2920938.height = 150, _5349459.textAlign = 'center', _5349459.textBaseline = 'middle', _5349459.font = '600 150px FontAwesome', _5349459.fillStyle = '#ffffff', _5349459.fillText('Ð“ÑžÐ²Ð‚â€œÐ’Ñ˜', 75, 75), _3188647.crossOrigin = 'anonymous', _3188647.src = _2920938.toDataURL(), _3188647;
			}
		}]), _2920938;
    })())(),
    ...
    G = new((() => {
		function _5295042() {
			_classCallCheck(this, _5295042), this.left = -7071, this.top = -7071, this.right = 7071, this.bottom = 7071, this.edge = 14142, this.offset = {
				'x': 0,
				'y': 0
			}, this.offset2 = {
				'x': 0,
    ...
    L = new((() => {
		function _3417938() {
			_classCallCheck(this, _3417938);
		}
		return _createClass(_3417938, [{
			'key': 'init',
			'value'() {
			...
			'value'() {
				A.isAlive ? (
					this.x += (A.x - this.x) / settings.cameraSpeed,
					this.y += (A.y - this.y) / settings.cameraSpeed
				) :
				this.isSpectating && (this.x = (29 * this.x + this.spectatePoints.x) / 30, this.y = (29 * this.y + this.spectatePoints.y) / 30);
			}
		}, {
			'key': 'updateView',
			'value'() {
				let _3417938 = this.targetViewport;
				'on' === settings.autoZoom && (_3417938 *= this.autoZoomViewport), this.viewport += (_3417938 - this.viewport) / 8;
				...
				this.viewBounds.left = Math.max(-_4728945 + this.x, G.left)
				this.viewBounds.right = Math.min(_4728945 + this.x, G.right)
				this.viewBounds.top = Math.max(-_2424152 + this.y, G.top)
				this.viewBounds.bottom = Math.min(_2424152 + this.y, G.bottom);
		...
		new (class{
		  ...
		  nick(cell) {
				if (cell.isUnnamed) return false;
				const lvl = cell.animRadius * L.viewport * (oe.cellNickSize / 100) * 0.3;
				if (10 > lvl && 'on' === settings.autoHideText) return false;
				const NickName = this.nickCaches.get(cell.nick) || this.newNickCache(cell.nick);
				NickName.lastUsedAt = le.time;
				...
				const newCanvas = this.getNewCanvas(),
				 ...
				 newCanvas.height =  fontSize + 6, 
				 newCanvas.width =  this.getNickWidth(cell.nick, fontSize) + 6, 
				 ctx.font = '700 ' + ( fontSize) + 'px ' + oe.nickFont, 
				 ctx.textBaseline = 'middle', 
				 'normal' === settings.nickShadow ? (ctx.strokeStyle = oe.nickStrokeColor, ctx.lineWidth = 6, ctx.strokeText(cell.nick, 3, newCanvas.height >> 1)) 
				 : 'performance' === settings.nickShadow && (ctx.fillStyle = oe.nickStrokeColor, ctx.globalAlpha = 0.75, ctx.fillRect(0, 0, newCanvas.width, newCanvas.height), ctx.globalAlpha = 1),
					ctx.fillStyle = oe.nickColor, 
					ctx.fillText(cell.nick, 3, newCanvas.height >> 1), 
					NickName.level[needLevel] = newCanvas
				
				 return newCanvas;
			}
		newNickCache(_4421815) {
				const _3651497 = new B();
				return this.nickCaches.set(_4421815, _3651497), _3651497;
			}
		getNickWidth(_4421815, _2595051) {
		  ...
		  mass(cell) {
				const lvl = cell.animRadius * L.viewport * (oe.cellMassSize / 100) * 0.3;
				if (!cell.isVirus && 10 > lvl && 'on' === settings.autoHideText) return false;
				const cached = this.massCaches.get(cell.id) || this.newMassCache(cell.id);
				cached.lastUsedAt = le.time;
				const massTxt = 'shortened' === settings.cellMass && 999 < cell.staticMass ? (0 | cell.staticMass / 100) / 10 + 'k' : cell.staticMass;
				cached.fontSize = lvl;
				const time = le.time - cached.lastUpdateAt;
				(cached.needsRedraw || time > this.massUpdateInterval) && (cached.mass = massTxt), 
				cached.canvas || (cached.canvas = this.getNewCanvas(), cached.ctx = cached.canvas.getContext('2d'))
				if (cached.needsRedraw) {
					//console.log('redraw',lvl)
					cached.needsRedraw = false;
					const canvas = cached.canvas,
					      ctx = cached.ctx;
					canvas.height = 0 | cached.fontSize + 6,
					canvas.width = 0 | this.getMassWidth(cached.mass, cached.fontSize) + 6,
					ctx.font = '700 ' + (0 | cached.fontSize) + 'px ' + oe.massFont, 
					ctx.textBaseline = 'middle', 
					'normal' === settings.massShadow ? (ctx.strokeStyle = oe.massStrokeColor, ctx.lineWidth = 6, ctx.strokeText(cached.mass, 3, canvas.height >> 1)) 
					:'performance' === settings.massShadow && (ctx.fillStyle = oe.massStrokeColor, ctx.globalAlpha = 0.75, ctx.fillRect(0, 0, canvas.width, canvas.height), ctx.globalAlpha = 1),
					ctx.fillStyle = oe.massColor, 
					ctx.fillText(cached.mass, 3, canvas.height >> 1), 
					cached.lastUpdateAt = le.time;
				}
				return cached.canvas;
			}
		  newMassCache(_4421815) {
				const _3953903 = new E();
				return this.massCaches.set(_4421815, _3953903), _3953903;
			}
		  getMassWidth(_4421815, _1856848) {
		  ...
		  getScreenRadius (_4421815){_4421815 * L.viewport}
		  isSmall(_4421815) {
				return 'on' === settings.autoHideText && 20 > this.getScreenRadius(_4421815.animRadius);
			}
		  getNewCanvas() {
		  ...
		  cleaner() {
				this.nickCaches.forEach((_4421815, _5494248) => {
					if (le.time - _4421815.lastUsedAt > this.maxCacheLife) {
						...
						for (var _2371802, _2672574 = _4421815.level, s = 0; s < _2672574.length; s++)(_2371802 = _2672574[s]) && this.resetCanvas(_2371802);
					}
    ...
    E = (() => {
		function _11077512() {
			_classCallCheck(this, _11077512)
    ...
    B = function e() {
		_classCallCheck(this, e), this.lastUsedAt = le.time, this.level = [null, null, null, null, null, null, null, null];
	}, H = new((() => {
		function _2315563() {
			_classCallCheck(this, _2315563);
		}
		return _createClass(_2315563, [{
			'key': 'init',
			'value'() {
				this.cache();
			}
			...
			'value'() {
				...
				for (; _3206289--;) {
					const _4089909 = I.food[_3206289],
						s = 2 === _4089909.tab ? G.getOffset2 : 3 === _4089909.tab ? G.getOffset3 : {
							'x': 0,
							'y': 0
						},
						_2422957 = _4089909.animRadius + oe.foodSize;
					_2315563.drawImage(this.cacheCanvas, ~~(_4089909.x - s.x + _2422957 / 2 - 200), ~~(_4089909.y - s.y + _2422957 / 2 - 200));
				}
			}
		}, {
			'key': 'rainbow',
			'value'() {
				for (let _2315563 = re.ctx, _2424617 = oe.foodSize, _13981775 = I.food.length; _13981775--;) {
					const _2181703 = I.food[_13981775],
						s = 2 === _2181703.tab ? G.getOffset2 : 3 === _2181703.tab ? G.getOffset3 : {
							'x': 0,
							'y': 0
						},
						_2150224 = _2181703.animRadius + _2424617;
					_2315563.fillStyle = _2181703.colorObject.hex, 2 > _2150224 * L.viewport ? _2315563.fillRect(_2181703.x - s.x - _2150224, _2181703.y - s.y - _2150224, 2 * _2150224, 2 * _2150224) : (_2315563.beginPath(), _2315563.arc(_2181703.x - s.x, _2181703.y - s.y, _2150224, 0, re.pi2, true), _2315563.closePath(), _2315563.fill());
				}
			}
		}]), _2315563;
    })())(),
    ...
    ie = new((() => {
		function _5896616() {
			_classCallCheck(this, _5896616), this.init();
		}
		return _createClass(_5896616, [{
			'key': 'init',
			'value'() {
			...
			'key': 'render',
			'value'() {
				const _3643066 = settings.opponentRings;
			...
			'value'(_3028328, _2354113) {
				...
				for (let _2001444 = _3028328.length; _2001444--;) {
					...
					const s = 2 === _1646767.tab ? G.getOffset2 : 3 === _1646767.tab ? G.getOffset3 : {
						'x': 0,
						'y': 0
					};
					_2440407.moveTo(_1646767.x - s.x + _1646767.animRadius + 15 + (this.lineWidth >> 1), _1646767.y - s.y), _2440407.arc(_1646767.x - s.x, _1646767.y - s.y, _1646767.animRadius + 15 + (this.lineWidth >> 1), 0, re.pi2, true);
				}
    ...
    ve = new((() => {
		function _4311880() {
			_classCallCheck(this, _4311880), this.init();
		}
		return _createClass(_4311880, [{
			'key': 'init',
			'value'() {
			...
			'value'() {
				if ('on' === settings.virusRange) {
					...
					_1715584.globalAlpha = 0.1, _1715584.fillStyle = '#ffffff', this.viruses.forEach(_5253006 => {
						const s = 2 === _5253006.tab ? G.getOffset2 : 3 === _5253006.tab ? G.getOffset3 : {
							'x': 0,
							'y': 0
						};
						const _4524563 = 0 < _5253006.fadeStartTime ? Math.max(1 - (le.time - _5253006.fadeStartTime) / settings.CellAnimation, 0) : 1;
						_1715584.globalAlpha = 0.1 * _4524563, _1715584.beginPath(), _1715584.arc(_5253006.x - s.x, _5253006.y - s.y, _5253006.animRadius + 760, 0, re.pi2, true), _1715584.closePath(), _1715584.fill();
    ...
    N = window.txt =  new((() => {
		function _3741862() {
			_classCallCheck(this, _3741862), this.skinMap = new Map(), this.downloadedSkins = new Map(), this.pi2 = 2 * Math.PI;
		}
		return _createClass(_3741862, [{
			'key': 'render',
			'value'() {
				this.skinMap.clear(), A.isAlive && (this.skinMap.set(A.worldID, settings.hideOwnSkin === 'on' ? '' : this.code2url(A.skin)), this.skinMap.set(A.worldID2, settings.hideOwnSkin === 'on' ? '' : this.code2url(A.skin2)));
			...
			'value'(_3741862) {
				...
				_1434097.crossOrigin = 'anonymous', _1434097.onload = () => {
					const _2458502 = document.createElement('canvas'),
						s = _2458502.getContext('2d');
					_2458502.width = 512, _2458502.height = 512, s.beginPath(), s.arc(256, 256, 256, 0, _1140287.pi2, true), s.closePath(), s.clip(), s.drawImage(_1434097, 0, 0, 512, 512), _1434097.onload = null, _1434097.src = _2458502.toDataURL(), _1140287.downloadedSkins.set(_3741862, _1434097);
    ...
    V = new((() => {
		function _2000799() {
			_classCallCheck(this, _2000799), this.left = 0, this.top = 0, this.sectorEdge = 0, this.edge = 0, this.halfSectorEdge = 0, this.letters = ['A', 'B', 'C', 'D', 'E'], this.visible = new Set();
		}
		return _createClass(_2000799, [{
			'key': 'render',
			'value'() {
				const _2000799 = settings.bgSectors;
				if ('off' !== _2000799 && 'fantasy' !== _2000799) {
					const _2806943 = re.ctx,
						_5657528 = oe.gridWidth,
						_3650539 = _5657528 >> 1;
					this.edge = G.edge - _5657528
					this.left = G.left + _3650539
					this.top = G.top + _3650539
					this.sectorEdge = 0 | this.edge / 5
					this.halfSectorEdge = 0 | this.edge / 10
					_2806943.lineWidth = _5657528
					_2806943.strokeStyle = oe.gridColor
					this.sectors()
					'onlyLines' === _2000799 || (_2806943.textAlign = 'center',
					_2806943.textBaseline = 'middle',
					_2806943.fillStyle = oe.gridTextColor,
					this.updateViewSectors(),
					'snowflakes' === _2000799 ? this.snowflakes() : this.normal());
				}
			}
		}, {
			'key': 'sectors',
			'value'() {
				...
				_2000799.beginPath(),
				_2000799.rect(this.left + this.sectorEdge, this.top, this.sectorEdge, this.edge),
				_2000799.rect(this.left + 3 * this.sectorEdge, this.top, this.sectorEdge, this.edge),
				_2000799.rect(this.left, this.top + this.sectorEdge, this.edge, this.sectorEdge),
				_2000799.rect(this.left, this.top + 3 * this.sectorEdge, this.edge, this.sectorEdge),
				_2000799.rect(this.left, this.top, this.edge, this.edge), _2000799.closePath(),
				_2000799.stroke();
			}
		}, {
			...
			'value'() {
				...
				_2000799.clear();
				for (let _3019673 = L.viewBounds, _5544443 = 0 | (_3019673.left - 200 - G.left) / this.sectorEdge, _12099062 = 0 | (_3019673.top - 200 - G.top) / this.sectorEdge, s = 5 - (0 | (G.right - _3019673.right - 200) / this.sectorEdge) - _5544443, _3475071 = 5 - (0 | (G.bottom - _3019673.bottom - 200) / this.sectorEdge) - _12099062, _5579350 = 0; _5579350 < s; _5579350++)
			...
			'value'() {
				...
				for (let _4877965, _1618352 = 0; 5 > _1618352; _1618352++) {
					...
					for (let _2575130, s = 0; 5 > s; s++)
						if (_2575130 = this.letters[_1618352] + (s + 1), this.visible.has(_2575130)) {
							const _1618352 = this.left + this.halfSectorEdge + s * this.sectorEdge;
    ...
    W = (() => {
		function _4348317() {
			_classCallCheck(this, _4348317);
		}
		return _createClass(_4348317, null, [{
			'key': 'init',
			'value'() {
				this.target1 = {
					'turnedOn': false,
			...
			'value'() {
				if (this.target1.turnedOn || this.target2.turnedOn) {
					...
					let _4404316 = 0,
						_2258760 = 0,
						s = 0;
					_4348317.turnedOn && (0 < _4348317.cellCount ? (_4348317.position.x /= _4348317.cellCount, _4348317.position.y /= _4348317.cellCount, _4348317.outOfView = false, _2258760 += _4348317.position.x, s += _4348317.position.y, _4404316++) : _4348317.outOfView = true), _6104869.turnedOn && (0 < _6104869.cellCount ? (_6104869.position.x /= _6104869.cellCount, _6104869.position.y /= _6104869.cellCount, _6104869.outOfView = false, _2258760 += _6104869.position.x, s += _6104869.position.y, _4404316++) : _6104869.outOfView = true), 0 < _4404316 && (this.center.x = 0 | _2258760 / _4404316, this.center.y = 0 | s / _4404316);
				}
			}
		}, {
			'key': 'lockTarget',
			'value'(_4348317, _7753884, _9755088) {
				...
				if (I.sortedCells.forEach(_9755088 => {
						if (!_9755088.isVirus && !_9755088.isEjected) {
							...
							_1980722 < _1071518 && (_1071518 = _1980722, s = _9755088);
						}
					}), s)
					if (s.isUnnamed) m.alert('HSLO', p.current.notif.target_unnamed);
					else {
						const _4348317 = 1 === _9755088 ? this.target1 : this.target2;
						_4348317.turnedOn = true, _4348317.nick = s.nick, _4348317.worldID = s.worldID, _4348317.outOfView = false, K.targetMode();
					}
			}
		}, {
			'key': 'getDistanceSquare',
			'value'(_4348317, _15499370, _3313798, _4135633) {
				const s = _3313798 - _4348317,
					_75092 = _4135633 - _15499370;
				return s * s + _75092 * _75092;
			}
		}, {
			'key': 'reset',
			'value'() {
    ...
    D = (() => {
		function _3994358(_2593005) {
			_classCallCheck(this, _3994358), this.dataView = _2593005, this.index = 0, this.maxIndex = _2593005.byteLength;
		}
		return _createClass(_3994358, [{
			'key': 'readUInt8',
			'value'() {
    ...
    X = (() => {
		function _2573803() {
			_classCallCheck(this, _2573803), this.arrayBuffer = [];
		}
		return _createClass(_2573803, [{
			'key': 'writeUint8',
			'value'(_2573803) {
    ...
    q = new((() => {
		function _5525236() {
			_classCallCheck(this, _5525236), this.ip = '', this.Tab1 = null, this.connectedTab1 = false, this.Tab2 = null, this.connectedTab2 = false, this.Tab3 = null, this.connectedTab3 = false, this.packetCount = {
				'in': 0,
				'out': 0
			}, this.ipBox = $('#ip-box');
			this.integrity = true
		}
		return _createClass(_5525236, [{
			'key': 'init',
			'value'(_5525236) {
				this.integrity = _5525236.indexOf('agar.io')>-1
				_5525236 && (this.disconnect(), this.resetData(), j.init(), G.reset(), this.address = _5525236, this.Tab1 = new WebSocket('wss://' + this.address), this.Tab1.binaryType = 'arraybuffer', this.Tab1.onopen = () => {
					...
					this.onError(1);
				}, settings.multiboxMode === 'on' && (this.Tab2 = new WebSocket('wss://' + _5525236), this.Tab2.binaryType = 'arraybuffer', this.Tab2.onopen = () => {
					...
					this.onError(3);
				}, m.alert('HSLO', 'Connecting to game server ' + $('#party-token').val() + '.'), console.info('Connecting to: ' + _5525236));
			}
		}, {
			'key': 'disconnect',
			'value'() {
    ...
    j = new((() => {
		function _2587362() {
			_classCallCheck(this, _2587362);
		}
		return _createClass(_2587362, [{
			'key': 'init',
			'value'() {
			...
			'value'(_2587362) {
				...
				for (var _8619836 = null, _2653975 = q.address.match(/([^:]*)(:\d+)/)[1], s = _2653975.length + _5302083.byteLength, _3939963 = new Uint8Array(s), _4499757 = 0; _4499757 < _2653975.length; _4499757++) _3939963[_4499757] = _2653975.charCodeAt(_4499757);
				_3939963.set(_5302083, _2653975.length);
				for (var r = new DataView(_3939963.buffer), _5039496 = s - 1, h = 0 | 4 + (-4 & _5039496 - 4), c = 255 ^ _5039496, _6093796 = 0; 3 < _5039496;) _8619836 = 0 | Math.imul(r.getInt32(_6093796, true), 1540483477), c = (0 | Math.imul(_8619836 >>> 24 ^ _8619836, 1540483477)) ^ (0 | Math.imul(c, 1540483477)), _5039496 -= 4, _6093796 += 4;
				switch (_5039496) {
				case 3:
					c = _3939963[h + 2] << 16 ^ c, c = _3939963[h + 1] << 8 ^ c;
					break;
				case 2:
					c = _3939963[h + 1] << 8 ^ c;
					break;
				...
				return _8619836 != c && (_8619836 = 0 | Math.imul(_3939963[h] ^ c, 1540483477)), _8619836 ^= c = _8619836 >>> 13, (_8619836 = 0 | Math.imul(_8619836, 1540483477)) ^ _8619836 >>> 15;
			}
		}, {
			'key': 'shiftKey',
    ...
    window.classj = j, Z = new((() => {
		...
		return _createClass(e, [{
			'key': 'getBuffer',
			'value'(e, _5516709) {
				e = new DataView(e.data), 1 == _5516709 ? j.protocolKey && (e = j.shiftMessage(e, j.protocolKey ^ le.versionInt)) : 2 == _5516709 ? j.protocolKey2 && (e = j.shiftMessage(e, j.protocolKey2 ^ le.versionInt)) : j.protocolKey3 && (e = j.shiftMessage(e, j.protocolKey3 ^ le.versionInt)), this.parse(e, _5516709);
			}
		}, {
			'key': 'parse',
			'value'(e, _5366527) {
			...
			'value'(e, t) {
				e.decompress();
				const _5357546 = e.readUInt8();
				16 === _5357546 ? this.worldUpdate(e, t) : 64 === _5357546 && this.borderUpdate(e, t);
			} */
				const _3749847 = new D(e),
					_5056131 = _3749847.readUInt8();
				17 === _5056131 ? this.getSpectateData(_3749847, _5366527) :
				18 === _5056131 ? this.clearCells(_5366527) :
				32 === _5056131 ? this.getMyCellId(_3749847, _5366527) :
				50 === _5056131 ? 1 === _5366527 && this.getLeaderboardTeam(_3749847) :
				53 === _5056131 ? 1 === _5366527 && this.getLeaderboardFFA(_3749847) :
				54 === _5056131 ? 1 === _5366527 && this.getLeaderboard(_3749847) :
				69 === _5056131 ? 3 === _5366527 && this.getGhost(_3749847) :
				85 === _5056131 && 3 != _5366527 ? y.display(_5366527) :
				102 === _5056131 ? (this.mobileData(_3749847, _5366527), 20 > _3749847.dataView.byteLength && (1 === _5366527 ? _5451753.logout() : _4188507.logout())) :
				103 === _5056131 ? 1 === _5366527 ? (Q.loggedIn = true, Q.freeCoins(1)) : (Q.loggedIn2 = true, Q.freeCoins(2)) :
				226 === _5056131 ? this.ping(_3749847, _5366527) :
				241 === _5056131 ? this.getReceiveKey(_3749847, _5366527) :
				16 === _5056131 ? this.worldUpdate(_3749847, _5366527) :
				64 === _5056131 ? this.borderUpdate(_3749847, _5366527) :
				255 === _5056131 && this.compressedPacket(_3749847, _5366527);
			}
		}, {
			'key': 'getGhost',
			'value'(e) {
				this.ghostCells = [];
				let _2843497 = e.readUInt16();
				for (let _4448568 = 0; _4448568 < _2843497; _4448568++) {
					let _2843497 = e.readInt32();
					let _4448568 = e.readInt32();
					let s = e.readUInt32();
					e.index++;
					let _5740235 = ~~Math.sqrt(100 * s);
				...
				window.ghostCells = this.ghostCells, window.ghostData = e;
			}
		}, {
			'key': 'calcSector',
			...
			'key': 'getSpectateData',
			'value'(e, _5261943) {
				3 !== _5261943 ? (2 !== _5261943 || A.isAlive) && (L.spectatePoints.x = e.readFloat32(), L.spectatePoints.y = e.readFloat32(), L.autoZoomViewport = e.readFloat32()) : 3 === _5261943 && (L.Tab3SpectatePoints.x = e.readFloat32(), L.Tab3SpectatePoints.y = e.readFloat32(), L.Tab3Viewport = e.readFloat32());
			}
		}, {
			'key': 'clearCells',
			'value'(e) {
				console.log('Reseting World...'), 1 == e ? (j.protocolKey && (j.protocolKey = j.shiftKey(j.protocolKey)), console.log('Reset Protocol Key 1: ' + j.protocolKey)) : 2 == e ? (j.protocolKey2 && (j.protocolKey2 = j.shiftKey(j.protocolKey2)), console.log('Reset Protocol Key 2: ' + j.protocolKey2)) : (j.protocolKey3 && (j.protocolKey3 = j.shiftKey(j.protocolKey3)), console.log('Reset Protocol Key 3: ' + j.protocolKey3)), 1 == e ? (I.cellsTab1.clear(), I.cellsIDTab1.clear(), I.myCellsTab1.clear(), console.log('Clearing tab 1 world')) : 2 == e ? (I.cellsTab2.clear(), I.cellsIDTab2.clear(), I.myCellsTab2.clear(), console.log('Clearing tab 2 world')) : (I.cellsTab3.clear(), I.cellsIDTab3.clear(), I.myCellsTab3.clear(), console.log('Clearing tab 3 world'));
			}
		}, {
			'key': 'getMyCellId',
			'value'(e, _2868077) {
				const _12753362 = 1 === _2868077 ? I.cellsIDTab1 : 2 === _2868077 ? I.cellsIDTab2 : I.cellsIDTab3,
					_1886557 = e.readUInt32();
			...
			'value'(e) {
				...
				for (e.readUInt16(); !e.endOfBuffer;) {
					...
					i = A.nick), 
					16 & t && (a = true), 
					(16 > o || n) && LEADERBOARD.add(i, o, n, a, s), 
					LEADERBOARD.playersAmount = o;
				}
				LEADERBOARD.update();
			}
		}, {
			...
			'value'(buffer) {
				LEADERBOARD.clear();
				for (let flags, i = 0; !buffer.endOfBuffer;) {
					i++;
					let name = 'unnamed cell',
						id = false,
						isPlayer = false,
						isFriend = false;
					1 & (flags = buffer.readUInt8()) && (i = buffer.readUInt16()),
					2 & flags && (name = buffer.readEscapedUTF8string()),
					4 & flags && (id = buffer.readUInt32()),
					8 & flags && (isPlayer = true, name = A.nick),
					16 & flags && (isFriend = true),
					(14 > i || isPlayer) && LEADERBOARD.add(name, i, isPlayer, isFriend, id),
					LEADERBOARD.playersAmount = i;
				}
				LEADERBOARD.update();
			}
		}, {
			...
			'value'(e) {
				LEADERBOARD.clear(), 
				e.readUInt32(), 
				LEADERBOARD.team(e.readFloat32(), 
				e.readFloat32(), 
				e.readFloat32());
			}
		}, {
			...
			'value'(e, t) {
				...
				for (; !e.endOfBuffer;) {
					...
					if (1 & r && (i.isVirus = true), 2 & r) {
						const t = e.readUInt8(),
							o = e.readUInt8(),
							s = e.readUInt8();
						i.colorObject.set(t, o, s);
					}
					4 & r && (i.skin = e.readUTF8string()), 8 & r && (i.nick = e.readEscapedUTF8string()), 32 & r && (i.isEjected = true), 1 & l && (i.isFood = true), 2 & l && (i.isFriend = true), 4 & l && (i.account = e.readUInt32());
				}
    ...
    Q = new((() => {
		function e() {
			...
			this.triedCoins = false, 
			this.triedCoins2 = false;
		}
		return _createClass(e, [{
			'key': 'init',
			'value'(e) {
				this.handshake1(e), 
				this.handshake2(e), 
				1 === e ? (q.connectedTab1 = true, 
				this.fbToken()) : 2 === e ? (q.connectedTab2 = true, 
				q.connectedTab3 = true, 
				this.googleToken()) : this.unknownToken(), 
			...
			'value'(e, t) {
				...
				if (1 === t) {
					...
					e = j.shiftMessage(e, j.clientKey), j.clientKey = j.shiftKey(j.clientKey);
				} else if (2 === t) {
					if (!j.clientKey2) return;
					e = j.shiftMessage(e, j.clientKey2), j.clientKey2 = j.shiftKey(j.clientKey2);
				} else {
					if (!j.clientKey3) return;
					e = j.shiftMessage(e, j.clientKey3), j.clientKey3 = j.shiftKey(j.clientKey3);
				}
				q.send(e.buffer, t);
			}
		}, {
			...
			'value'(e) {
				...
				_5239886.setUint8(0, 255, true), _5239886.setUint32(1, le.versionInt, true), q.send(_5239886.buffer, e);
			}
		}, {
			'key': 'mouse',
			'value'(e, _2483034) {
				...
				if (this.connected(_4684425)) {
					...
					s.setUint8(0, 16, true), s.setInt32(1, e, true), s.setInt32(5, _2483034, true), s.setInt32(9, _1423052, true), this.sendPacket(s, _4684425);
				}
			}
		}, {
			'key': 'spectate',
			'value'(e) {
				const _2301044 = e || 1;
				if (this.connected(_2301044) || !A.isAlive && !L.isSpectating || e) {
					const e = this.createView(1);
					e.setUint8(0, 1, true), this.sendPacket(e, _2301044), _2301044 != 3 ? L.isSpectating = true : L.isSpectating = false, A.isAlive || (L.targetViewport = 0.1);
				}
			}
		}, {
			'key': 'captcha',
			'value'(e, _1486970) {
				if (this.connected(_1486970)) {
					...
					const _5124225 = e.length;
					let _267378 = _5124225;
					const s = this.createView(2 + _5124225);
					for (s.setUint8(0, 86, true); _267378--;) s.setUint8(_267378 + 1, e.charCodeAt(_267378), true);
					s.setUint8(_5124225 + 1, 0, true), this.sendPacket(s, _1486970);
				}
			}
		}, {
			'key': 'spawn',
			'value'() {
				...
				if (this.connected(e) || !(A.isAliveTab1 && 1 === e || A.isAliveTab2 && 2 === e)) {
					grecaptcha.ready(() => {
						grecaptcha.execute(0, {
							'action': 'play'
						}).then(function (_2064730) {
							1 === e ? Q.fbToken() : Q.googleToken(), L.isSpectating = false;
							const _3644369 = 1 === e ? A.nick : A.nick2,
								_10441906 = unescape(encodeURIComponent(_3644369)),
								_3542529 = _10441906.length,
								c = _2064730.length,
								s = _5238175.createView(3 + _3542529 + c);
							s.setUint8(0, 0, true);
							for (let e = 0; e < _3542529; e++) s.setUint8(e + 1, _10441906.charCodeAt(e), true);
							s.setUint8(_3542529 + 1, 0, true);
							for (let _3477933 = 0; _3477933 < c; _3477933++) s.setUint8(_3477933 + _3542529 + 2, _2064730.charCodeAt(_3477933), true);
							s.setUint8(c + _3542529 + 2, 0, true);
							_5238175.sendPacket(s, e);
						});
					});
					Q.spectate(3);
				}
			...
			'value'(e, _4269747) {
				...
				if (this.connected(_1312866) && (!this.loggedIn || 2 !== _4269747) && (!this.loggedIn2 || 4 !== _4269747)) {
					...
					for (_1559445.push(24, 0, 32, 0, 26), this.writeUint32(_1559445, _1312866 + 3), _1559445.push(10), this.writeUint32(_1559445, _1312866), _5713588 = 0; _5713588 < _1312866; _5713588++) _1559445.push(e.charCodeAt(_5713588));
					_1559445 = new Uint8Array(_1559445);
					var s = new DataView(_1559445.buffer);
					2 === _4269747 ? this.sendPacket(s, 1) : 4 == _4269747 && this.sendPacket(s, 2);
				}
			}
		}, {
			'key': 'split',
			'value'(_4603672) {
				const e = _4603672 === 1 ? 1 : _4603672 === 2 ? 2 : A.controllingTab;
				if (this.connected(e)) {
					const _5478827 = this.createView(1);
					_5478827.setUint8(0, 17, true), this.sendPacket(_5478827, e);
				}
			}
		}, {
			'key': 'eject',
			'value'() {
				...
				if (this.connected(e)) {
					...
					_3375071.setUint8(0, 21, true), this.sendPacket(_3375071, e);
				}
			}
		}, {
			'key': 'freeSpectate',
			'value'() {
				if (this.connected(1)) {
					...
					const e = this.createView(1);
					e.setUint8(0, 18, true), this.sendPacket(e, 1);
				}
			}
		}, {
			'key': 'freeCoins',
			...
			'value'(e, _3269569) {
				if (this.connected(_3269569)) {
					...
					_5658032.setUint8(0, 227, true), _5658032.setUint16(1, e, true), this.sendPacket(_5658032, _3269569);
				}
			}
		}, {
			'key': 'fbToken',
			...
			'value'(e, _5134437) {
				for (;;) {
					if (0 == (-128 & _5134437)) return void e.push(_5134437);
					e.push(128 | 127 & _5134437), _5134437 >>>= 7;
				}
			}
		}]), e;
    })())(),
    ...
    Y = new((() => {
		function _11953611() {
			_classCallCheck(this, _11953611);
		}
		return _createClass(_11953611, [{
			'key': 'createParty',
			'value'() {
				$('#loading-screen').append('<div class=\"info\"><i class=\"fas fa-copyright\"></i> 2019 HSLO.</div>'), g.createParty(), t.finishUp();
			}
		}]), _11953611;
    })())(),
    ...
    J = new((() => {
		function _7065734() {
			_classCallCheck(this, _7065734), this.address = 'snez.org:8080/ws?555', this.ogarWS1 = null, this.ogarWS2 = null;
		}
		return _createClass(_7065734, [{
			'key': 'init',
			'value'() {
				const self = this;
				this.ogarWS1 = new WebSocket('wss://' + this.address), 
				this.ogarWS1.binaryType = 'arraybuffer', 
				this.ogarWS1.onopen = () => self.onOpen(1), 
				this.ogarWS1.onmessage = _5500276 => self.onMessage(_5500276, 1), 
				this.ogarWS1.onclose = () => self.onClose(1), 
				this.ogarWS1.onerror = () => self.onError(1), 
				settings.multiboxMode === 'on' && (this.ogarWS2 = new WebSocket('wss://' + this.address), 
				this.ogarWS2.binaryType = 'arraybuffer', this.ogarWS2.onopen = () => self.onOpen(2), 
				this.ogarWS2.onmessage = _3141600 => self.onMessage(_3141600, 2), 
				this.ogarWS2.onclose = () => self.onClose(2), this.ogarWS2.onerror = () => self.onError(2)), 
    ...
    _e = new((() => {
		function _4495393() {
			_classCallCheck(this, _4495393);
		}
		return _createClass(_4495393, [{
			'key': 'init',
			'value'() {
				try {
			...
			'value'() {
				...
				_4495393.writeUint8(0), _4495393.writeUint16(407);
				try {
			...
			'key': 'partyToken',
			'value'() {
				const _4495393 = $('#party-token').val();
			...
			'key': 'serverToken',
			'value'() {
				const _4495393 = !!q.address && q.address.match(/live-arena-([\w\d]+(\.tech)?)\.agar\.io:\d+/); 
			...
			'key': 'region',
			'value'() {
				const _4495393 = $('#regions').val().split('-');
    ...
    window.class_e = _e, ae = new((() => {
		function _3393126() {
			_classCallCheck(this, _3393126), this.connectedIndex = 0;
		}
		return _createClass(_3393126, [{
			'key': 'parse',
			...
			'value'(_3393126, _6505825) {
				...
				const id = _3393126.readUInt32(),
					player = se.getPlayer(id);
				player.nick = _3393126.readUTF16string(), 
				player.skin = _3393126.readUTF16string(), 
				_3393126.readUTF16string(), 
				player.colorHex = _3393126.readUTF16string();
				//console.log(player)
			}
		}, {
			'key': 'prePlayersAlive',
			...
			'value'(_3393126, _5166575) {
				...
				} else if (_2563704 === '[SERVER]' && s.includes('connected')) {
					++this.connectedIndex, m.alert('OGARio', 'Tab ' + this.connectedIndex + ' connected to szymy\'s server.');
				} else {
					101 === _2288039 ? m.normal(_2563704, s) : 102 === _2288039 && m.command(_2563704, s);
				};
			}
		}]), _3393126;
    })())(),
    ...
    se = new((() => {
		function _1405786() {
			_classCallCheck(this, _1405786), this.playerID = 0, this.playerID2 = 0, this.teammates = new Map();
		}
		return _createClass(_1405786, [{
			'key': 'getPlayer',
			'value'(_1405786) {
    ...
    be = new((() => {
		function _3384158() {
			_classCallCheck(this, _3384158);
		}
		return _createClass(_3384158, [{
			'key': 'init',
			'value'() {
				this.cache();
			}
			...
			'value'() {
				const _3384158 = re.ctx,
					_5039288 = 'off' !== settings.borderGlow,
					_3112242 = oe.borderWidth >> 1,
					_4755164 = 'off' !== settings.borderGlow && oe.borderGlowStrength ? oe.borderGlowStrength : 1;
				...
				if (settings.showViewportBoxes === 'on') {
					_3384158.save();
	...
	de = new((() => {
		function _7797780() {
			_classCallCheck(this, _7797780);
		}
		return _createClass(_7797780, [{
			'key': 'init',
			'value'() {
				this.cache();
			}
			...
			'value'() {
				...
				for (; _3243214--;) {
					const _3423870 = I.sortedCells[_3243214],
						s = 2 === _3423870.tab ? G.getOffset2 : 3 === _3423870.tab ? G.getOffset3 : {
							'x': 0,
							'y': 0
						},
						_1555626 = 100 + 5;
					_3423870.isVirus && _7797780.drawImage(this.cacheCanvas, ~~(_3423870.x - s.x + _1555626 / 2 - 350), ~~(_3423870.y - s.y + _1555626 / 2 - 350));
				}
			}
		}, {
			'key': 'cache',
	...
	re = new((() => {
		function _2668636() {
			const _2595915 = this;
			_classCallCheck(this, _2668636), this.canvas = document.getElementById('canvas'), this.ctx = this.canvas.getContext('2d'), this.pi2 = 2 * Math.PI, this.commanderPoints = new Set(), this.maouImg = null, this.fantasyImg = null, this.resizeCanvas(), this.getMaouImg(), this.getEveryoneSkin(), this.getFantasyImg(), window.onresize = () => {
				_2595915.resizeCanvas();
			};
		}
		return _createClass(_2668636, [{
			'key': 'resizeCanvas',
			'value'() {
			...
			'value'() {
				if (null !== this.fantasyImg) {
					...
					'fantasy' === settings.bgSectors && (_2668636.beginPath(), _2668636.drawImage(this.fantasyImg, ~~G.left, ~~G.top, ~~G.edge, ~~G.edge), _2668636.closePath());
				}
			}
		}, {
			'key': 'cells',
			'value'() {
				var ctx = this.ctx;
				var isCellMass = "off" !== settings.cellMass;
				var isCellNick = "off" !== settings.cellNick;
				var isHideOwnNick = "on" === settings.hideOwnNick;
				var isHideOwnMass = "on" === settings.hideOwnMass;
				var isUrlSkins = "on" === settings.urlSkins;
				var isTeamIndicator = "on" === settings.teamIndicator;
				var isMultiboxRing = "on" === settings.multiboxRing;
				var isMaouCircleSkin = "off" !== settings.maouCircleSkin;
				var isVirusGlow = "off" !== settings.virusGlow;
				var valSkinBorder = oe.skinBorder / 100;
				var valIndicatorSize = oe.indicatorSize;
				var valCellTransparency = oe.cellTransparency / 100;
				var valCellNickSize = oe.cellNickSize / 100;
				var valCellMassSize = oe.cellMassSize / 100;
				var valCellTextAnimation = settings.cellTextAnimation;
				var valCellTextAnimation = "off" === valCellTextAnimation ? 0 : "stepped" === valCellTextAnimation ? 1 : 2;
				var valLightenCellColor = oe.lightenCellColor / 100;
				var valVirusColor = oe.virusColor;
				var isMultiboxActive = oe.multiboxActive;
				var isMultiboxInactive = oe.multiboxInactive;
				var valMultiboxRingWidth = oe.multiboxRingWidth;
				ctx.strokeStyle = oe.virusBorderColor;
				ctx.lineWidth = oe.virusBorderWidth;
				var _11448571 = function setup() {
					var i = 0;
					for (; i < oe.virusGlowStrength; i++) {
						ctx.stroke();
					}
				};
				...
				try {
					var _iterator3 = I.sortedCells[Symbol.iterator]();
					var _step6;
					for (; !(_iteratorNormalCompletion3 = (_step6 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {


						var cell = _step6.value;
						var tabOffset = 2 === cell.tab ? G.getOffset2 : 3 === cell.tab ? G.getOffset3 : {
							"x" : 0,
							"y" : 0
						};
						var reverseIsSingle = !cell.isVirus && !cell.isEjected && N.skinMap.has(cell.worldID);
						var delay = 1;
						if (cell.fadeStartTime) {
							delay = 1 - _5736151;
						}
						delay = 0 > delay ? 0 : 1 < delay ? 1 : delay;
						ctx.beginPath();
						ctx.arc(cell.x - tabOffset.x, cell.y - tabOffset.y, cell.animRadius + 5, 0, this.pi2, true);
						ctx.closePath();
						if (cell.isVirus) {
							ctx.drawImage(de.cacheCanvas, ~~(cell.x - tabOffset.x + (100 + 5) / 2 - 350), ~~(cell.y - tabOffset.y + (100 + 5) / 2 - 350));
							if ("fill" === settings.virusMass) {
								ctx.beginPath();
								ctx.arc(cell.x - tabOffset.x, cell.y - tabOffset.y, ~~(2.5 * (cell.animRadius - 100)), 0, this.pi2, true);
								ctx.closePath();
								ctx.fillStyle = oe.virusBorderColor;
								ctx.fill();
							}
						} else {
							ctx.fillStyle = this.getColor(cell.colorObject, valLightenCellColor);
							if (1 > valCellTransparency * delay) {
								ctx.globalAlpha = valCellTransparency * delay;
								ctx.fill();
								ctx.globalAlpha = 1;
							} else {
								ctx.fill();
						...
						if (!cell.isEjected) {
							if (!cell.isVirus) {
								if (1 == delay && isTeamIndicator && !cell.isMine && reverseIsSingle && 50 > cell.animRadius * L.viewport) {
									ctx.drawImage(R.indicator, ~~(cell.x - tabOffset.x - valIndicatorSize / 2), ~~(cell.y - tabOffset.y - cell.animRadius - 10 - valIndicatorSize), ~~valIndicatorSize, ~~valIndicatorSize);
								}
								var accessors = isMaouCircleSkin ? cell.animRadius * valMultiboxRingWidth / 75 : 0;
								var canvasSkin = reverseIsSingle && isUrlSkins && N.getCustomSkin(cell.worldID);
								var cosineSquared = cell.animRadius * valSkinBorder;
								var isHideOwnMass = 16 * cell.animRadius / 100;
								if (canvasSkin) {
									ctx.drawImage(canvasSkin ? canvasSkin : canvasSkin, ~~(cell.x - tabOffset.x - (cosineSquared + 5 - accessors)), ~~(cell.y - tabOffset.y - (cosineSquared + 5 - accessors)), ~~(2 * (cosineSquared + 5 - accessors)), ~~(2 * (cosineSquared + 5 - accessors)));
								}
								if (N.getCustomSkin(cell.worldID) && isMaouCircleSkin) {
									ctx.save();
									ctx.arc(~~(cell.x - tabOffset.x + 540), ~~(cell.x - tabOffset.x + 540), 540, 0, this.pi2, true);
									ctx.shadowBlur = 25 * L.viewport;
									ctx.shadowColor = cell.isMine && isMultiboxRing ? cell.tab === 1 && A.controllingTab === 1 ? isMultiboxActive : cell.tab === 2 && A.controllingTab === 2 ? isMultiboxActive : isMultiboxInactive : cell.colorObject.hex;
									ctx.drawImage(this.maouImg, ~~(cell.x - tabOffset.x - (cell.animRadius + 5 + isHideOwnMass)), ~~(cell.y - tabOffset.y - (cell.animRadius + 5 + isHideOwnMass)), ~~(2 * (cell.animRadius + 5 + isHideOwnMass)), ~~(2 * (cell.animRadius + 5 + isHideOwnMass)));
									ctx.restore();
								}
								if (cell.isMine) {
									var accessors = isMaouCircleSkin ? 20 : 0;
									var _3937730 = cell.animRadius * (valMultiboxRingWidth + accessors) / 100;
									if (isMultiboxRing) {
										ctx.beginPath();
										ctx.arc(cell.x - tabOffset.x, cell.y - tabOffset.y, cell.animRadius + 5 - (_3937730 >> 1), 0, this.pi2, true);
										ctx.closePath();
										ctx.lineWidth = 0 | _3937730;
										ctx.strokeStyle = cell.tab === A.controllingTab ? isMultiboxActive : isMultiboxInactive;
										ctx.stroke();
										ctx.strokeStyle = oe.virusBorderColor;
										ctx.lineWidth = oe.virusBorderWidth;
									}
									var _2 = 16 * cell.animRadius / 100;
									if (isMaouCircleSkin) {
										ctx.beginPath();
										ctx.drawImage(this.maouImg, ~~(cell.x - tabOffset.x - (cell.animRadius + 5 + _2)), ~~(cell.y - tabOffset.y - (cell.animRadius + 5 + _2)), ~~(2 * (cell.animRadius + 5 + _2)), ~~(2 * (cell.animRadius + 5 + _2)));
										ctx.closePath();
									}
								}
								if (1 == delay && (cell.isMine && !isHideOwnMass || !cell.isMine && isCellNick)) {
									var canvasSkin = P.nick(cell);
									if (canvasSkin) {
										var scale = (
											(
											2 == valCellTextAnimation ? cell.animRadius
											:1 == valCellTextAnimation ? 50 + 75 * (0 | cell.animRadius / 100) 
											: cell.animRadius
											) * valCellNickSize * 0.3 + 6 / L.viewport
										) / canvasSkin.height;
										//this.nickSize = ~~(this.fontSize * this.nickScale);
										//console.log(valCellNickSize)
										//hei = tr/hei
										/*var p35 = valCellNickSize *33 * (cell.animRadius / 100) 
										//console.log(valCellNickSize)
										var p = (cell.animRadius / 100)
										var scale = (
											(p35)  //* 1 * 0.3 + 6 / L.viewport
										) / 50//canvasSkin.height;*/
										//console.log(canvasSkin.height,p35)
										var shrink = (50/canvasSkin.height)
										var sWidth = canvasSkin.width*scale//canvasSkin.width * scale;
										var sHeight = canvasSkin.height * scale;
										ctx.drawImage(canvasSkin, ~~(cell.x - tabOffset.x - (sWidth >> 1)), ~~(cell.y - tabOffset.y - (sHeight >> 1)), ~~sWidth, ~~sHeight);
									}
								}
							}
							if ((!cell.isVirus || "text" === settings.virusMass && cell.isVirus) && 1 == delay && (cell.isMine && !isHideOwnMass || !cell.isMine && isCellMass)) {
								var canvasMass = P.mass(cell);
								if (canvasMass) {
									var scale = 
									  (
										  (
											 2 == valCellTextAnimation ? cell.animRadius :
											 1 == valCellTextAnimation ? 50 + 75 * (0 | cell.animRadius / 75) :
											 cell.animRadius
												) * valCellMassSize * 0.3 + 6 / L.viewport
										) / canvasMass.height;

										var scale = 
									  (
										  (cell.animRadius) * valCellMassSize * 0.3 + 6 / 1//L.viewport
										) / canvasMass.height;
												//this.fontSize = Math.max(this.size * 0.3, 26) * this.scale;
												//this.massSize = Math.ceil(this.virMassSize * this.scale * this.virMassScale);
									var sWidth = canvasMass.width * scale;
									var sHeight = canvasMass.height * scale;
									var yPos = cell.y - tabOffset.y + (cell.isUnnamed || cell.isMine && isHideOwnNick || !cell.isMine && !isCellNick ? -sHeight >> 1 : sHeight >> 2);
									ctx.drawImage(canvasMass, ~~(cell.x - tabOffset.x - (sWidth >> 1)), ~~yPos, ~~sWidth, ~~sHeight);
								}
							}
						}
					}
			...
			'value'() {
				...
				_2668636.src = 'https://i.imgur.com/UHnXvDk.png', _2668636.crossOrigin = 'anonymous', _2668636.onload = () => {
					const _3282680 = document.createElement('canvas'),
			...
			'value'() {
				...
				_2668636.src = 'https://i.imgur.com/dne3Rtn.png', _2668636.crossOrigin = 'anonymous', _2668636.onload = () => {
					const _2022371 = document.createElement('canvas'),
			...
			'value'() {
				window.HSLObackgroundImage = new Image(), window.changeBGImage = _2668636 => {
					_2668636 && localStorage.setItem('bgURL', _2668636), document.getElementById('customBG').value = localStorage.getItem('bgURL'), HSLObackgroundImage.src = localStorage.getItem('bgURL'), HSLObackgroundImage.crossOrigin = 'anonymous', HSLObackgroundImage.onload = () => {
						const _2668636 = document.createElement('canvas'),
				...
				}, localStorage.getItem('bgURL') ? changeBGImage() : changeBGImage('https://i.imgur.com/H7oaPKw.png'), localStorage.getItem('LBHead') ? changeLB() : changeLB('HSLO V5'), setTimeout(function () {
					editEmojiLink();
				}, 1);
				window.getSettings = () => {
					let _9322534 = {};
					document.getElementById('checkProfiles').checked && (_9322534.profiles = JSON.parse(localStorage.getItem(c.prefix + 'profiles')));
					document.getElementById('checkSettings').checked && (_9322534.settings = JSON.parse(localStorage.getItem(c.prefix + 'settings')));
					document.getElementById('checkTheme').checked && (_9322534.theme = JSON.parse(localStorage.getItem(c.prefix + 'theme')));
					document.getElementById('checkHotkeys').checked && (_9322534.hotkeys = JSON.parse(localStorage.getItem(c.prefix + 'hotkeys')));
					document.getElementById('checkCommands').checked && (_9322534.commands = JSON.parse(localStorage.getItem(c.prefix + 'commands')));
					document.getElementById('checkMouse').checked && (_9322534.mouse = JSON.parse(localStorage.getItem(c.prefix + 'mouse')));
				...
				window.loadSettings = () => {
					...
					if (typeof _4409273 != 'object' || !_4409273) {
						...
						document.getElementById('checkProfiles').checked && _4409273.profiles && localStorage.setItem(c.prefix + 'profiles', JSON.stringify(_4409273.profiles));
						document.getElementById('checkSettings').checked && _4409273.settings && localStorage.setItem(c.prefix + 'settings', JSON.stringify(_4409273.settings));
						document.getElementById('checkTheme').checked && _4409273.theme && localStorage.setItem(c.prefix + 'theme', JSON.stringify(_4409273.theme));
						document.getElementById('checkHotkeys').checked && _4409273.hotkeys && localStorage.setItem(c.prefix + 'hotkeys', JSON.stringify(_4409273.hotkeys));
						document.getElementById('checkCommands').checked && _4409273.commands && localStorage.setItem(c.prefix + 'commands', JSON.stringify(_4409273.commands));
						document.getElementById('checkMouse').checked && _4409273.mouse && localStorage.setItem(c.prefix + 'mouse', JSON.stringify(_4409273.mouse));
			...
			'value'() {
				const _2668636 = this.ctx,
					_5379255 = 'off' === settings.commander;
				...
				for (const _5193846 of this.commanderPoints.values()) {
					...
					if (1250 < _5534849) this.commanderPoints.delete(_5193846);
						...
						const _5193846 = _2668636.createRadialGradient(_2776538, s, 0.7 * _5379255, _2776538, s, _5379255);
						_5193846.addColorStop(0, 'rgba(0,0,0,0)'), _5193846.addColorStop(1, oe.commanderColor), _2668636.fillStyle = _5193846, _2668636.beginPath(), _2668636.arc(_2776538, s, _5379255, 0, this.pi2, true), _2668636.closePath(), _2668636.fill(), _2668636.stroke();
					}
				}
			}
		}, {
			...
			'value'() {
				if ('off' !== settings.cursorLine) {
					...
					for (const _5143004 of _16307846.values()) _2668636.moveTo(_5143004.x - s.x, _5143004.y - s.y), _2668636.lineTo(_1191603, _5668575);
	...
	le = new((() => {
		function _5582385() {
			_classCallCheck(this, _5582385), this.time = Date.now(), this.versionInt = localStorage.getItem('parsedKey') || 30601, this.versionString = localStorage.getItem('key') || '3.6.1', console.log('Current Client Version: ' + this.versionInt + ' ' + this.versionString);
			...
			'value'() {
				...
				try {
					window.ghostCells = [{
						...
						'mass': 1000,
						'size': 333
					}], z.init(), I.init(), A.init(), L.init(), J.init(), H.init(), de.init(), be.init(),
					 this.loop = new o(() => {
						_5582385.run();
					}),
					setInterval(() => {
    ...
    (() => {
		try {
			//le.checkConsole();
			const _1368672 = ['Ð“ÑžÐ•â€œÐ’Ò‘Ð“ÑžÐ²Ð‚â„–Ð²Ð‚ Ð“ÑžÐ•â€œÐ’Â§', '3pF4N(>c@,hqnNG<', 'U>P#&[N2_#q^_rmF', '5cB8p{S\"!D:Fhd7S', '$_R6)=@W>aHb3qh?', 'Ð“ÐŽÐ–â€™Ð’Â¦HSLOV5-Public-TokenÐ“ÐŽÐ–â€™Ð’Â¦', 'Ð“ÑžÐ²â€žÑžÐ’ÒHSLOV5-Friends-TokenÐ“ÑžÐ²â€žÑžÐ’Ò', ',L_X6?CgxGNx^<<('];
			p.init(), le.init(), y.asyncInit();
